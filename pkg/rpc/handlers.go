...
func (s *Server) CollectStats(localAddr net.Addr) map[string]string {
	...
	udpDuplicatedSeqNumsReceived := s.udpStatsPerSecond.DuplicatedSeqNumsReceived.Load()
	udpOutOfWindowSeqNumsReceived := s.udpStatsPerSecond.OutOfWindowSeqNumsReceived.Load()
	...
	m["udp_duplicated_seq_nums_received"] = strconv.FormatInt(udpDuplicatedSeqNumsReceived, 10)
	m["udp_out_of_window_seq_nums_received"] = strconv.FormatInt(udpOutOfWindowSeqNumsReceived, 10)
