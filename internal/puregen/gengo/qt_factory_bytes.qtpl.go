...
func (gen *genGo) streamgenerateFactoryBytes(qw422016 *qt422016.Writer, sortedImports []string, directImports *DirectImports) {
...
func (gen *genGo) writegenerateFactoryBytes(qq422016 qtio422016.Writer, sortedImports []string, directImports *DirectImports) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	gen.streamgenerateFactoryBytes(qw422016, sortedImports, directImports)
	qt422016.ReleaseWriter(qw422016)
}

func (gen *genGo) generateFactoryBytes(sortedImports []string, directImports *DirectImports) string {
