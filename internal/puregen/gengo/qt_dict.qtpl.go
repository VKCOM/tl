...
`)
    ...
    for i := range *vec {
        `)
			qw422016.N().S(tuple.element.t.TypeRepairMasksCode(bytesVersion, directImports, tuple.wr.ins, "(*vec)[i]", tuple.wr.formatNatArgs(nil, tuple.element.NatArgs()), false))
			qw422016.N().S(`
    }
}
`)
		...
		qw422016.N().S(`func `)
		qw422016.N().S(goName)
		qw422016.N().S(`ReadTL1(w []byte, vec *`)
		qw422016.N().S(typeString)
		qw422016.N().S(` `)
		qw422016.N().S(natDecl)
...
func `)
		qw422016.N().S(goName)
		qw422016.N().S(`WriteTL1(w []byte, vec `)
		qw422016.N().S(typeString)
		qw422016.N().S(` `)
		qw422016.N().S(natDecl)
		qw422016.N().S(`) `)
	...
	*vec = (*vec)[:cap(*vec)]
	...
	if in != nil {
        ...
        for ;!in.IsDelim('}'); index++ {
            ...
            in.WantColon()
            `)
			qw422016.N().S(tuple.dictValueField.t.TypeJSON2ReadingCode(bytesVersion, directImports, tuple.wr.ins, "in", "(*vec)[index]."+valueFieldName, tuple.formatValueNatArgs(), false))
			qw422016.N().S(`
            in.WantComma()
        }
        in.Delim('}')
...
func `)
    ...
    return `)
			qw422016.N().S(goName)
			qw422016.N().S(`WriteJSONOpt(&jctx, w, vec`)
...
func `)
    ...
    for _, elem := range vec {
        ...
        w = append(w, ':')
        `)
			qw422016.N().S(tuple.dictValueField.t.TypeJSONWritingCode(bytesVersion, directImports, tuple.wr.ins, "elem."+valueFieldName, tuple.formatValueNatArgs(), false, writeElementNeedsError))
			qw422016.N().S(`
    }
`)
			if writeElementNeedsError {
	...
	*vec = (*vec)[:cap(*vec)]
	...
	if in != nil {
        ...
        for ;!in.IsDelim('}'); index++ {
            ...
            `)
			qw422016.N().S(tuple.dictKeyField.t.TypeJSON2ReadingCode(bytesVersion, directImports, tuple.wr.ins, "&in2", "(*vec)[index]."+keyFieldName, tuple.wr.formatNatArgs(nil, tuple.dictKeyField.NatArgs()), false))
			qw422016.N().S(`
            in.WantColon()
            `)
			qw422016.N().S(tuple.dictValueField.t.TypeJSON2ReadingCode(bytesVersion, directImports, tuple.wr.ins, "in", "(*vec)[index]."+valueFieldName, tuple.formatValueNatArgs(), false))
...
func `)
    ...
    for _, elem := range vec {
        ...
        w = append(w, `)
			...
			qw422016.N().S(`...)
        `)
			qw422016.N().S(tuple.dictKeyField.t.TypeJSONWritingCode(bytesVersion, directImports, tuple.wr.ins, "key", tuple.wr.formatNatArgs(nil, tuple.dictKeyField.NatArgs()), false, tuple.dictKeyField.t.hasErrorInWriteMethods))
			qw422016.N().S(`
        w = append(w, `)
			qw422016.N().S("`")
			qw422016.N().S(`":`)
			...
			qw422016.N().S(`...)
        `)
			qw422016.N().S(tuple.dictValueField.t.TypeJSONWritingCode(bytesVersion, directImports, tuple.wr.ins, "elem."+valueFieldName, tuple.formatValueNatArgs(), false, tuple.dictValueField.t.hasErrorInWriteMethods))
			qw422016.N().S(`
    }
`)
			if writeElementNeedsError {
    ...
    *m = make(map[`)
    ...
    for i := 0; i < int(l); i++ {
        var elem `)
			...
			qw422016.N().S(`
        `)
			qw422016.N().S(tuple.element.t.TypeRandomCode(bytesVersion, directImports, tuple.wr.ins, "elem", tuple.wr.formatNatArgs(nil, tuple.element.NatArgs()), false))
			qw422016.N().S(`
        (*m)[elem.`)
			qw422016.N().S(keyFieldName)
			qw422016.N().S(`] = elem.`)
...
`)
    ...
    for key, val := range *m {
        elem := `)
			...
			qw422016.N().S(`:val}
        `)
			qw422016.N().S(tuple.element.t.TypeRepairMasksCode(bytesVersion, directImports, tuple.wr.ins, "elem", tuple.wr.formatNatArgs(nil, tuple.element.NatArgs()), false))
			qw422016.N().S(`
        (*m)[key] = elem.`)
			qw422016.N().S(valueFieldName)
			qw422016.N().S(`
...
`)
		...
		qw422016.N().S(`func `)
		qw422016.N().S(goName)
		qw422016.N().S(`ReadTL1(w []byte, m *map[`)
		qw422016.N().S(keyTypeString)
		qw422016.N().S(`]`)
		qw422016.N().S(valueTypeString)
		qw422016.N().S(` `)
...
`)
    ...
    for i := 0; i < int(l); i++ {
        var elem `)
			...
			qw422016.N().S(`
        `)
			qw422016.N().S(tuple.element.t.TypeReadingCode(bytesVersion, directImports, tuple.wr.ins, "elem", tuple.element.Bare(), tuple.wr.formatNatArgs(nil, tuple.element.NatArgs()), false, false))
			qw422016.N().S(`
         data[elem.`)
			qw422016.N().S(keyFieldName)
			qw422016.N().S(`] = elem.`)
...
func `)
		qw422016.N().S(goName)
		qw422016.N().S(`WriteTL1(w []byte, m map[`)
		qw422016.N().S(keyTypeString)
		qw422016.N().S(`]`)
		qw422016.N().S(valueTypeString)
		qw422016.N().S(` `)
...
func `)
		qw422016.N().S(goName)
		qw422016.N().S(`ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, m *`)
		qw422016.N().S(typeString)
		qw422016.N().S(` `)
		qw422016.N().S(valueNatArgsDecl)
		qw422016.N().S(`) error {
...
`)
		if tuple.dictKeyString {
			...
			qw422016.N().S(`
            `)
			qw422016.N().S(tuple.dictValueField.t.TypeJSON2ReadingCode(bytesVersion, directImports, tuple.wr.ins, "in", "value", tuple.formatValueNatArgs(), false))
			qw422016.N().S(`
            data[key] = value
`)
		} else {
			...
			qw422016.N().S(`
            `)
			qw422016.N().S(tuple.dictKeyField.t.TypeJSON2ReadingCode(bytesVersion, directImports, tuple.wr.ins, "&in2", "key", tuple.wr.formatNatArgs(nil, tuple.dictKeyField.NatArgs()), false))
			qw422016.N().S(`
            var value `)
			qw422016.N().S(valueTypeString)
			qw422016.N().S(`
...
func `)
    ...
    return `)
		qw422016.N().S(goName)
		qw422016.N().S(`WriteJSONOpt(&jctx, w, m`)
		qw422016.N().S(valueNatArgsCall)
		qw422016.N().S(`)
}
`)
		if tuple.dictKeyString {
			qw422016.N().S(`func `)
			qw422016.N().S(goName)
			qw422016.N().S(`WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte, m `)
			qw422016.N().S(typeString)
			qw422016.N().S(` `)
			qw422016.N().S(valueNatArgsDecl)
			qw422016.N().S(`) `)
...
`)
    ...
    for _, key := range keys {
        ...
        w = append(w, ':')
        `)
			qw422016.N().S(tuple.dictValueField.t.TypeJSONWritingCode(bytesVersion, directImports, tuple.wr.ins, "value", tuple.formatValueNatArgs(), false, tuple.dictValueField.t.hasErrorInWriteMethods))
			qw422016.N().S(`
    }
`)
			if writeElementNeedsError {
