...
func (gen *genGo) streamgenerateNamespacesCode(qw422016 *qt422016.Writer, anyTypeAlias bool, anyFunctions bool, name string, namespace *Namespace, sortedImports []string, directImports *DirectImports) {
...
`)
    ...
    `)
		qw422016.N().Q(gen.options.Go.BasicRPCPath)
		qw422016.N().S(`
    `)
...
type Handler struct {
    `)
	streamhandlerStructs(qw422016, gen, name, namespace.types, directImports, ourTypes)
	qw422016.N().S(` }
...
`)
	if totalFuns != 0 {
		qw422016.N().S(`    `)
		streamhandleRequest(qw422016, gen, namespace.types, directImports)
	}
...
func (gen *genGo) writegenerateNamespacesCode(qq422016 qtio422016.Writer, anyTypeAlias bool, anyFunctions bool, name string, namespace *Namespace, sortedImports []string, directImports *DirectImports) {
...
func (gen *genGo) generateNamespacesCode(anyTypeAlias bool, anyFunctions bool, name string, namespace *Namespace, sortedImports []string, directImports *DirectImports) string {
...
func streamtypesAlias(qw422016 *qt422016.Writer, gen *genGo, anyTypeAlias bool, namespace string, types []*TypeRWWrapper, directImports *DirectImports, ourTypes map[*TypeRWWrapper]struct{}) {
	if anyTypeAlias {
		qw422016.N().S(`type(
`)
...
func writetypesAlias(qq422016 qtio422016.Writer, gen *genGo, anyTypeAlias bool, namespace string, types []*TypeRWWrapper, directImports *DirectImports, ourTypes map[*TypeRWWrapper]struct{}) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	streamtypesAlias(qw422016, gen, anyTypeAlias, namespace, types, directImports, ourTypes)
	qt422016.ReleaseWriter(qw422016)
}

func typesAlias(gen *genGo, anyTypeAlias bool, namespace string, types []*TypeRWWrapper, directImports *DirectImports, ourTypes map[*TypeRWWrapper]struct{}) string {
	qb422016 := qt422016.AcquireByteBuffer()
...
func writehandlerStructs(qq422016 qtio422016.Writer, gen *genGo, name string, types []*TypeRWWrapper, directImports *DirectImports, ourTypes map[*TypeRWWrapper]struct{}) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	streamhandlerStructs(qw422016, gen, name, types, directImports, ourTypes)
	qt422016.ReleaseWriter(qw422016)
}

func handlerStructs(gen *genGo, name string, types []*TypeRWWrapper, directImports *DirectImports, ourTypes map[*TypeRWWrapper]struct{}) string {
	qb422016 := qt422016.AcquireByteBuffer()
	writehandlerStructs(qb422016, gen, name, types, directImports, ourTypes)
	qs422016 := string(qb422016.B)
	qt422016.ReleaseByteBuffer(qb422016)
	return qs422016
}

func streamhandleRequest(qw422016 *qt422016.Writer, gen *genGo, types []*TypeRWWrapper, directImports *DirectImports) {
...
func writehandleRequest(qq422016 qtio422016.Writer, gen *genGo, types []*TypeRWWrapper, directImports *DirectImports) {
	qw422016 := qt422016.AcquireWriter(qq422016)
	streamhandleRequest(qw422016, gen, types, directImports)
	qt422016.ReleaseWriter(qw422016)
}

func handleRequest(gen *genGo, types []*TypeRWWrapper, directImports *DirectImports) string {
	qb422016 := qt422016.AcquireByteBuffer()
	writehandleRequest(qb422016, gen, types, directImports)
	qs422016 := string(qb422016.B)
	qt422016.ReleaseByteBuffer(qb422016)
	return qs422016
}
