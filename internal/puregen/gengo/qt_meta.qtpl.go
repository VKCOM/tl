...
func (item *TLItem) ReadTL1Boxed(w []byte) ([]byte, error) { return basictl.NatReadExactTag(w, item.tag) }
...
func (item *TLItem) WriteTL1BoxedGeneral(w []byte) ([]byte, error) { return basictl.NatWrite(w, item.tag), nil }
