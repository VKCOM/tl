...
#include "basictl/dependencies.h"
#include "basictl/constants.h"
...
namespace tlgen::basictl {
    ...
    public:
        ...
        void nat_read(uint32_t &value) {
            if (ptr + tlgen::basictl::TL_UINT32_SIZE > end_block) [[unlikely]] {
                return fetch_data2(&value, tlgen::basictl::TL_UINT32_SIZE);
            }
            std::memcpy(reinterpret_cast<char *>(&value), ptr, tlgen::basictl::TL_UINT32_SIZE);
            ptr += tlgen::basictl::TL_UINT32_SIZE;
        }
        ...
        void int_read(int32_t &value) {
            if (ptr + tlgen::basictl::TL_INT32_SIZE > end_block) [[unlikely]] {
                return fetch_data2(&value, tlgen::basictl::TL_INT32_SIZE);
            }
            std::memcpy(reinterpret_cast<char *>(&value), ptr, tlgen::basictl::TL_INT32_SIZE);
            ptr += tlgen::basictl::TL_INT32_SIZE;
        };
        ...
        void long_read(int64_t &value) {
            if (ptr + tlgen::basictl::TL_INT64_SIZE > end_block) [[unlikely]] {
                return fetch_data2(&value, tlgen::basictl::TL_INT64_SIZE);
            }
            std::memcpy(reinterpret_cast<char *>(&value), ptr, tlgen::basictl::TL_INT64_SIZE);
            ptr += tlgen::basictl::TL_INT64_SIZE;
        };
        ...
        void float_read(float &value) {
            if (ptr + tlgen::basictl::TL_FLOAT32_SIZE > end_block) [[unlikely]] {
                return fetch_data2(&value, tlgen::basictl::TL_FLOAT32_SIZE);
            }
            std::memcpy(reinterpret_cast<char *>(&value), ptr, tlgen::basictl::TL_FLOAT32_SIZE);
            ptr += tlgen::basictl::TL_FLOAT32_SIZE;
        };
        ...
        void double_read(double &value) {
            if (ptr + tlgen::basictl::TL_FLOAT64_SIZE > end_block) [[unlikely]] {
                return fetch_data2(&value, tlgen::basictl::TL_FLOAT64_SIZE);
            }
            std::memcpy(reinterpret_cast<char *>(&value), ptr, tlgen::basictl::TL_FLOAT64_SIZE);
            ptr += tlgen::basictl::TL_FLOAT64_SIZE;
        }
    ...
    public:
        ...
        void nat_write(uint32_t value) {
            if (ptr + tlgen::basictl::TL_UINT32_SIZE > end_block) [[unlikely]] {
                return store_data2(&value, tlgen::basictl::TL_UINT32_SIZE);
            }
            std::memcpy(ptr, reinterpret_cast<const char *>(&value), tlgen::basictl::TL_UINT32_SIZE);
            ptr += tlgen::basictl::TL_UINT32_SIZE;
        };

        void int_write(int32_t value) {
            if (ptr + tlgen::basictl::TL_INT32_SIZE > end_block) [[unlikely]] {
                return store_data2(&value, tlgen::basictl::TL_INT32_SIZE);
            }
            std::memcpy(ptr, reinterpret_cast<const char *>(&value), tlgen::basictl::TL_INT32_SIZE);
            ptr += tlgen::basictl::TL_INT32_SIZE;
        };

        void long_write(int64_t value) {
            if (ptr + tlgen::basictl::TL_INT64_SIZE > end_block) [[unlikely]] {
                return store_data2(&value, tlgen::basictl::TL_INT64_SIZE);
            }
            std::memcpy(ptr, reinterpret_cast<const char *>(&value), tlgen::basictl::TL_INT64_SIZE);
            ptr += tlgen::basictl::TL_INT64_SIZE;
        };

        void float_write(float value) {
            if (ptr + tlgen::basictl::TL_FLOAT32_SIZE > end_block) [[unlikely]] {
                return store_data2(&value, tlgen::basictl::TL_FLOAT32_SIZE);
            }
            std::memcpy(ptr, reinterpret_cast<const char *>(&value), tlgen::basictl::TL_FLOAT32_SIZE);
            ptr += tlgen::basictl::TL_FLOAT32_SIZE;
        };

        void double_write(double value) {
            if (ptr + tlgen::basictl::TL_FLOAT64_SIZE > end_block) [[unlikely]] {
                return store_data2(&value, tlgen::basictl::TL_FLOAT64_SIZE);
            }
            std::memcpy(ptr, reinterpret_cast<const char *>(&value), tlgen::basictl::TL_FLOAT64_SIZE);
            ptr += tlgen::basictl::TL_FLOAT64_SIZE;
        };
