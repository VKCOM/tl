#include "../meta/headers.h"
#include "headers.h"

#include "../tl/__common_namespace/types/withFloat.h"
#include "../tl/__common_namespace/types/vector.h"
#include "../tl/unique/functions/unique.stringToInt.h"
#include "../tl/unique/functions/unique.get.h"
#include "../tl/__common_namespace/types/tuple.h"
#include "../tl/tree_stats/types/tree_stats.objectLimitValueLong.h"
#include "../tl/tasks/types/tasks.TaskStatusItems.h"
#include "../tl/tasks/types/tasks.taskInfo.h"
#include "../tl/tasks/types/tasks.queueTypeInfo.h"
#include "../tl/tasks/types/tasks.queueTypeSettings.h"
#include "../tl/tasks/types/tasks.queueStats.h"
#include "../tl/tasks/functions/tasks.getTaskFromQueue.h"
#include "../tl/tasks/functions/tasks.getQueueTypes.h"
#include "../tl/tasks/functions/tasks.getQueueSize.h"
#include "../tl/tasks/functions/tasks.getAnyTask.h"
#include "../tl/tasks/types/tasks.cronTaskWithId.h"
#include "../tl/tasks/types/tasks.cronTask.h"
#include "../tl/tasks/types/tasks.cronTime.h"
#include "../tl/tasks/functions/tasks.addTask.h"
#include "../tl/tasks/types/tasks.task.h"
#include "../tl/__common_namespace/types/string.h"
#include "../tl/__common_namespace/types/statOne.h"
#include "../tl/service6/functions/service6.multiFindWithBounds.h"
#include "../tl/service6/functions/service6.multiFind.h"
#include "../tl/service6/types/service6.findWithBoundsResult.h"
#include "../tl/service5/functions/service5.query.h"
#include "../tl/service5/functions/service5.performQuery.h"
#include "../tl/service5/types/service5.params.h"
#include "../tl/service5/types/service5.Output.h"
#include "../tl/service5/types/service5.stringOutput.h"
#include "../tl/service5/functions/service5.insert.h"
#include "../tl/service5/types/service5.emptyOutput.h"
#include "../tl/service4/types/service4.modifiedNewsEntry.h"
#include "../tl/service4/types/service4.object.h"
#include "../tl/service3/functions/service3.setLimits.h"
#include "../tl/service3/functions/service3.setLastVisitTimestamp.h"
#include "../tl/service3/functions/service3.restoreProduct.h"
#include "../tl/service3/functions/service3.restoreGroupedProducts.h"
#include "../tl/service3/functions/service3.restoreAllProducts.h"
#include "../tl/service3/types/service3.productStatsOld.h"
#include "../tl/service3/types/service3.limits.h"
#include "../tl/service3/types/service3.groupSizeLimit.h"
#include "../tl/service3/types/service3.groupCountLimit.h"
#include "../tl/service3/functions/service3.getScheduledProducts.h"
#include "../tl/service3/functions/service3.getProducts.h"
#include "../tl/service3/functions/service3.getProductStats.h"
#include "../tl/service3/functions/service3.getLimits.h"
#include "../tl/service3/functions/service3.getLastVisitTimestamp.h"
#include "../tl/service3/functions/service3.deleteProduct.h"
#include "../tl/service3/functions/service3.deleteGroupedProducts.h"
#include "../tl/service3/functions/service3.deleteAllProducts.h"
#include "../tl/service3/functions/service3.createProduct.h"
#include "../tl/service2/functions/service2.setObjectTtl.h"
#include "../tl/service2/functions/service2.set.h"
#include "../tl/service2/functions/service2.addOrIncrMany.h"
#include "../tl/service1/functions/service1.touch.h"
#include "../tl/service1/functions/service1.setOrIncr.h"
#include "../tl/service1/functions/service1.set.h"
#include "../tl/service1/functions/service1.replaceOrIncr.h"
#include "../tl/service1/functions/service1.replace.h"
#include "../tl/service1/types/service1.keysStat.h"
#include "../tl/service1/functions/service1.incr.h"
#include "../tl/service1/functions/service1.getWildcardWithFlags.h"
#include "../tl/service1/functions/service1.getWildcardList.h"
#include "../tl/service1/functions/service1.getWildcardDict.h"
#include "../tl/service1/functions/service1.getWildcard.h"
#include "../tl/service1/functions/service1.getKeysStatPeriods.h"
#include "../tl/service1/functions/service1.getKeysStat.h"
#include "../tl/service1/functions/service1.getExpireTime.h"
#include "../tl/service1/functions/service1.get.h"
#include "../tl/service1/functions/service1.exists.h"
#include "../tl/service1/functions/service1.enableKeysStat.h"
#include "../tl/service1/functions/service1.enableExpiration.h"
#include "../tl/service1/functions/service1.disableKeysStat.h"
#include "../tl/service1/functions/service1.disableExpiration.h"
#include "../tl/service1/functions/service1.delete.h"
#include "../tl/service1/functions/service1.decr.h"
#include "../tl/service1/functions/service1.cas.h"
#include "../tl/service1/functions/service1.append.h"
#include "../tl/service1/functions/service1.addOrIncr.h"
#include "../tl/service1/functions/service1.addOrGet.h"
#include "../tl/service1/functions/service1.add.h"
#include "../tl/__common_namespace/types/rpcInvokeReqExtra.h"
#include "../tl/__common_namespace/types/true.h"
#include "../tl/pkg2/types/pkg2.t1.h"
#include "../tl/pkg2/types/pkg2.foo.h"
#include "../tl/__common_namespace/types/nonOptNat.h"
#include "../tl/__common_namespace/types/myTwoDicts.h"
#include "../tl/__common_namespace/types/myMcValueVector.h"
#include "../tl/__common_namespace/types/myMcValueTuple.h"
#include "../tl/__common_namespace/types/myMcValue.h"
#include "../tl/__common_namespace/types/myBoxedVectorSlice.h"
#include "../tl/__common_namespace/types/long.h"
#include "../tl/__common_namespace/types/issue3498.h"
#include "../tl/service6/types/service6.findResultRow.h"
#include "../tl/service6/types/service6.error.h"
#include "../tl/__common_namespace/types/int.h"
#include "../tl/__common_namespace/functions/getStats.h"
#include "../tl/tasks/types/tasks.queueTypeStats.h"
#include "../tl/__common_namespace/functions/getNonOptNat.h"
#include "../tl/__common_namespace/functions/getMyValue.h"
#include "../tl/__common_namespace/types/MyValue.h"
#include "../tl/__common_namespace/types/myString.h"
#include "../tl/__common_namespace/types/myInt.h"
#include "../tl/__common_namespace/functions/getMyDouble.h"
#include "../tl/__common_namespace/types/myDouble.h"
#include "../tl/__common_namespace/functions/getMyDictOfInt.h"
#include "../tl/__common_namespace/types/myDictOfInt.h"
#include "../tl/__common_namespace/functions/getMaybeIface.h"
#include "../tl/service1/types/service1.Value.h"
#include "../tl/service1/types/service1.strvalueWithTime.h"
#include "../tl/service1/types/service1.strvalue.h"
#include "../tl/service1/types/service1.not_found.h"
#include "../tl/service1/types/service1.longvalueWithTime.h"
#include "../tl/service1/types/service1.longvalue.h"
#include "../tl/__common_namespace/functions/getFloat.h"
#include "../tl/__common_namespace/functions/getDouble.h"
#include "../tl/__common_namespace/functions/get_arrays.h"
#include "../tl/__common_namespace/types/float.h"
#include "../tl/__common_namespace/types/fieldConflict4.h"
#include "../tl/__common_namespace/types/fieldConflict3.h"
#include "../tl/__common_namespace/types/fieldConflict2.h"
#include "../tl/__common_namespace/types/fieldConflict1.h"
#include "../tl/__common_namespace/types/double.h"
#include "../tl/__common_namespace/types/dictionary.h"
#include "../tl/__common_namespace/functions/boxedVector64.h"
#include "../tl/__common_namespace/functions/boxedVector32BoxedElem.h"
#include "../tl/__common_namespace/functions/boxedVector32.h"
#include "../tl/__common_namespace/functions/boxedTupleSlice3.h"
#include "../tl/__common_namespace/functions/boxedTupleSlice2.h"
#include "../tl/__common_namespace/types/myBoxedTupleSlice.h"
#include "../tl/__common_namespace/functions/boxedTupleSlice1.h"
#include "../tl/__common_namespace/functions/boxedTuple.h"
#include "../tl/__common_namespace/functions/boxedString.h"
#include "../tl/__common_namespace/functions/boxedInt.h"
#include "../tl/__common_namespace/functions/boxedArray.h"
#include "../tl/__common_namespace/types/myBoxedArray.h"
#include "../tl/__common_namespace/types/boolStat.h"
#include "../tl/__common_namespace/types/Bool.h"
#include "../tl/__common_namespace/types/benchObject.h"
#include "../tl/__common_namespace/types/integer.h"
#include "../tl/antispam/types/antispam.PatternFull.h"
#include "../tl/antispam/types/antispam.patternNotFound.h"
#include "../tl/antispam/types/antispam.patternFound.h"
#include "../tl/antispam/functions/antispam.getPattern.h"
