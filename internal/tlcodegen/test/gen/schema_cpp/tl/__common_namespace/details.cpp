...
#include "headers/nonOptNat.h"
#include "headers/myTwoDicts.h"
#include "headers/myMcValueVector.h"
#include "headers/myMcValueTuple.h"
#include "headers/myMcValue.h"
#include "headers/myMaybe2.h"
#include "headers/myMaybe1.h"
...
#include "headers/getStats.h"
#include "../tasks/headers/tasks.queueTypeStats.h"
#include "headers/getNonOptNat.h"
#include "headers/getMyValue.h"
#include "headers/MyValue.h"
#include "headers/myString.h"
#include "headers/myInt.h"
#include "headers/getMyDouble.h"
#include "headers/myDouble.h"
#include "headers/getMyDictOfInt.h"
#include "headers/myDictOfInt.h"
#include "headers/getMaybeIface.h"
#include "headers/getFloat.h"
#include "headers/getDouble.h"
#include "headers/get_arrays.h"
#include "headers/float.h"
#include "headers/fieldConflict4.h"
#include "headers/fieldConflict3.h"
#include "headers/fieldConflict2.h"
#include "headers/fieldConflict1.h"
#include "headers/Either.h"
#include "headers/right.h"
#include "headers/left.h"
...
#include "headers/boxedTupleSlice3.h"
#include "headers/boxedTupleSlice2.h"
#include "headers/myBoxedTupleSlice.h"
#include "headers/boxedTupleSlice1.h"
#include "headers/boxedTuple.h"
#include "headers/boxedString.h"
#include "headers/boxedInt.h"
#include "headers/boxedArray.h"
...
bool tl2::BoxedArray::read_result(::basictl::tl_istream & s, ::tl2::MyBoxedArray & result) {
	auto read_result = tl2::details::BoxedArrayReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedArray::write_result(::basictl::tl_ostream & s, ::tl2::MyBoxedArray & result) {
	auto write_result = tl2::details::BoxedArrayWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedInt::read_result(::basictl::tl_istream & s, int32_t & result) {
	auto read_result = tl2::details::BoxedIntReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedInt::write_result(::basictl::tl_ostream & s, int32_t & result) {
	auto write_result = tl2::details::BoxedIntWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedString::read_result(::basictl::tl_istream & s, std::string & result) {
	auto read_result = tl2::details::BoxedStringReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedString::write_result(::basictl::tl_ostream & s, std::string & result) {
	auto write_result = tl2::details::BoxedStringWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedTuple::read_result(::basictl::tl_istream & s, std::array<int32_t, 3> & result) {
	auto read_result = tl2::details::BoxedTupleReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedTuple::write_result(::basictl::tl_ostream & s, std::array<int32_t, 3> & result) {
	auto write_result = tl2::details::BoxedTupleWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedTupleSlice1::read_result(::basictl::tl_istream & s, std::vector<int32_t> & result) {
	auto read_result = tl2::details::BoxedTupleSlice1ReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedTupleSlice1::write_result(::basictl::tl_ostream & s, std::vector<int32_t> & result) {
	auto write_result = tl2::details::BoxedTupleSlice1WriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedTupleSlice2::read_result(::basictl::tl_istream & s, ::tl2::MyBoxedTupleSlice & result) {
	auto read_result = tl2::details::BoxedTupleSlice2ReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedTupleSlice2::write_result(::basictl::tl_ostream & s, ::tl2::MyBoxedTupleSlice & result) {
	auto write_result = tl2::details::BoxedTupleSlice2WriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedTupleSlice3::read_result(::basictl::tl_istream & s, std::vector<int32_t> & result) {
	auto read_result = tl2::details::BoxedTupleSlice3ReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedTupleSlice3::write_result(::basictl::tl_ostream & s, std::vector<int32_t> & result) {
	auto write_result = tl2::details::BoxedTupleSlice3WriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedVector32::read_result(::basictl::tl_istream & s, std::vector<int32_t> & result) {
	auto read_result = tl2::details::BoxedVector32ReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedVector32::write_result(::basictl::tl_ostream & s, std::vector<int32_t> & result) {
	auto write_result = tl2::details::BoxedVector32WriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedVector32BoxedElem::read_result(::basictl::tl_istream & s, std::vector<int32_t> & result) {
	auto read_result = tl2::details::BoxedVector32BoxedElemReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedVector32BoxedElem::write_result(::basictl::tl_ostream & s, std::vector<int32_t> & result) {
	auto write_result = tl2::details::BoxedVector32BoxedElemWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::BoxedVector64::read_result(::basictl::tl_istream & s, std::vector<int64_t> & result) {
	auto read_result = tl2::details::BoxedVector64ReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::BoxedVector64::write_result(::basictl::tl_ostream & s, std::vector<int64_t> & result) {
	auto write_result = tl2::details::BoxedVector64WriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::Get_arrays::read_result(::basictl::tl_istream & s, std::array<int32_t, 5> & result) {
	auto read_result = tl2::details::GetArraysReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::Get_arrays::write_result(::basictl::tl_ostream & s, std::array<int32_t, 5> & result) {
	auto write_result = tl2::details::GetArraysWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetDouble::read_result(::basictl::tl_istream & s, double & result) {
	auto read_result = tl2::details::GetDoubleReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetDouble::write_result(::basictl::tl_ostream & s, double & result) {
	auto write_result = tl2::details::GetDoubleWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetFloat::read_result(::basictl::tl_istream & s, float & result) {
	auto read_result = tl2::details::GetFloatReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetFloat::write_result(::basictl::tl_ostream & s, float & result) {
	auto write_result = tl2::details::GetFloatWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetMaybeIface::read_result(::basictl::tl_istream & s, std::optional<::tl2::service1::Value> & result) {
	auto read_result = tl2::details::GetMaybeIfaceReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetMaybeIface::write_result(::basictl::tl_ostream & s, std::optional<::tl2::service1::Value> & result) {
	auto write_result = tl2::details::GetMaybeIfaceWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetMyDictOfInt::read_result(::basictl::tl_istream & s, ::tl2::MyDictOfInt & result) {
	auto read_result = tl2::details::GetMyDictOfIntReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetMyDictOfInt::write_result(::basictl::tl_ostream & s, ::tl2::MyDictOfInt & result) {
	auto write_result = tl2::details::GetMyDictOfIntWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetMyDouble::read_result(::basictl::tl_istream & s, ::tl2::MyDouble & result) {
	auto read_result = tl2::details::GetMyDoubleReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetMyDouble::write_result(::basictl::tl_ostream & s, ::tl2::MyDouble & result) {
	auto write_result = tl2::details::GetMyDoubleWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetMyValue::read_result(::basictl::tl_istream & s, ::tl2::MyValue & result) {
	auto read_result = tl2::details::GetMyValueReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetMyValue::write_result(::basictl::tl_ostream & s, ::tl2::MyValue & result) {
	auto write_result = tl2::details::GetMyValueWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetNonOptNat::read_result(::basictl::tl_istream & s, std::vector<int32_t> & result) {
	auto read_result = tl2::details::GetNonOptNatReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetNonOptNat::write_result(::basictl::tl_ostream & s, std::vector<int32_t> & result) {
	auto write_result = tl2::details::GetNonOptNatWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::GetStats::read_result(::basictl::tl_istream & s, ::tl2::tasks::QueueTypeStats & result) {
	auto read_result = tl2::details::GetStatsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::GetStats::write_result(::basictl::tl_ostream & s, ::tl2::tasks::QueueTypeStats & result) {
	auto write_result = tl2::details::GetStatsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
