#include "headers/service3_vector.h"
#include "headers/service3.setLimits.h"
#include "headers/service3.setLastVisitTimestamp.h"
#include "headers/service3.restoreProduct.h"
#include "headers/service3.restoreGroupedProducts.h"
#include "headers/service3.restoreAllProducts.h"
#include "headers/service3.productStatsOld.h"
#include "headers/service3.product.h"
#include "headers/service3.limits.h"
#include "headers/service3.groupSizeLimit.h"
#include "headers/service3.groupCountLimit.h"
#include "headers/service3.getScheduledProducts.h"
#include "headers/service3.getProducts.h"
#include "headers/service3.getProductStats.h"
#include "headers/service3.getLimits.h"
#include "headers/service3.getLastVisitTimestamp.h"
#include "headers/service3.deleteProduct.h"
#include "headers/service3.deleteGroupedProducts.h"
#include "headers/service3.deleteAllProducts.h"
#include "headers/service3.createProduct.h"
#include "../__common_namespace/headers/int.h"
#include "headers/service3_boolStat.h"
...
bool tl2::service3::CreateProduct::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3CreateProductReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::CreateProduct::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3CreateProductWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::DeleteAllProducts::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3DeleteAllProductsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::DeleteAllProducts::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3DeleteAllProductsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::DeleteGroupedProducts::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3DeleteGroupedProductsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::DeleteGroupedProducts::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3DeleteGroupedProductsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::DeleteProduct::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3DeleteProductReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::DeleteProduct::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3DeleteProductWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::GetLastVisitTimestamp::read_result(::basictl::tl_istream & s, std::optional<int32_t> & result) {
	auto read_result = tl2::details::Service3GetLastVisitTimestampReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::GetLastVisitTimestamp::write_result(::basictl::tl_ostream & s, std::optional<int32_t> & result) {
	auto write_result = tl2::details::Service3GetLastVisitTimestampWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::GetLimits::read_result(::basictl::tl_istream & s, ::tl2::service3::Limits & result) {
	auto read_result = tl2::details::Service3GetLimitsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::GetLimits::write_result(::basictl::tl_ostream & s, ::tl2::service3::Limits & result) {
	auto write_result = tl2::details::Service3GetLimitsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::GetProductStats::read_result(::basictl::tl_istream & s, std::optional<std::vector<::tl2::service3::ProductStatsOld>> & result) {
	auto read_result = tl2::details::Service3GetProductStatsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::GetProductStats::write_result(::basictl::tl_ostream & s, std::optional<std::vector<::tl2::service3::ProductStatsOld>> & result) {
	auto write_result = tl2::details::Service3GetProductStatsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::GetProducts::read_result(::basictl::tl_istream & s, std::optional<std::vector<::tl2::service3::Product>> & result) {
	auto read_result = tl2::details::Service3GetProductsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::GetProducts::write_result(::basictl::tl_ostream & s, std::optional<std::vector<::tl2::service3::Product>> & result) {
	auto write_result = tl2::details::Service3GetProductsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::GetScheduledProducts::read_result(::basictl::tl_istream & s, std::optional<std::vector<::tl2::service3::Productmode<0>>> & result) {
	auto read_result = tl2::details::Service3GetScheduledProductsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::GetScheduledProducts::write_result(::basictl::tl_ostream & s, std::optional<std::vector<::tl2::service3::Productmode<0>>> & result) {
	auto write_result = tl2::details::Service3GetScheduledProductsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::RestoreAllProducts::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3RestoreAllProductsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::RestoreAllProducts::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3RestoreAllProductsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::RestoreGroupedProducts::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3RestoreGroupedProductsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::RestoreGroupedProducts::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3RestoreGroupedProductsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::RestoreProduct::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3RestoreProductReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::RestoreProduct::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3RestoreProductWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::SetLastVisitTimestamp::read_result(::basictl::tl_istream & s, bool & result) {
	auto read_result = tl2::details::Service3SetLastVisitTimestampReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::SetLastVisitTimestamp::write_result(::basictl::tl_ostream & s, bool & result) {
	auto write_result = tl2::details::Service3SetLastVisitTimestampWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
...
bool tl2::service3::SetLimits::read_result(::basictl::tl_istream & s, ::tl2::BoolStat & result) {
	auto read_result = tl2::details::Service3SetLimitsReadResult(s, *this, result);
	if (read_result) {
		s.last_release();
	}
	return read_result;
...
bool tl2::service3::SetLimits::write_result(::basictl::tl_ostream & s, ::tl2::BoolStat & result) {
	auto write_result = tl2::details::Service3SetLimitsWriteResult(s, *this, result);
	if (write_result) {
		s.last_release();
	}
	return write_result;
