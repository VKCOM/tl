...
struct GetMyValue {
	...
	void read_result_or_throw(::basictl::tl_throwable_istream & s, ::tl2::MyValue & result);
	void write_result_or_throw(::basictl::tl_throwable_ostream & s, ::tl2::MyValue & result);
