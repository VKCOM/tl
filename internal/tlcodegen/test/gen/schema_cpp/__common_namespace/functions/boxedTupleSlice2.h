...
struct BoxedTupleSlice2 {
	...
	void read_result_or_throw(::basictl::tl_throwable_istream & s, ::tl2::MyBoxedTupleSlice & result) noexcept;
	void write_result_or_throw(::basictl::tl_throwable_ostream & s, ::tl2::MyBoxedTupleSlice & result) noexcept;
