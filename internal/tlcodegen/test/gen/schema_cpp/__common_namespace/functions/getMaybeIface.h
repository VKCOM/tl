...
struct GetMaybeIface {
	...
	void read_result_or_throw(::basictl::tl_throwable_istream & s, std::optional<::tl2::service1::Value> & result) noexcept;
	void write_result_or_throw(::basictl::tl_throwable_ostream & s, std::optional<::tl2::service1::Value> & result) noexcept;
