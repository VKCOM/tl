...
struct GetWildcard {
	...
	void read_result_or_throw(::basictl::tl_throwable_istream & s, std::vector<::tl2::Map<std::string, std::string>> & result);
	void write_result_or_throw(::basictl::tl_throwable_ostream & s, std::vector<::tl2::Map<std::string, std::string>> & result);
