...
struct GetWildcardList {
	...
	void read_result_or_throw(::basictl::tl_throwable_istream & s, std::vector<std::string> & result);
	void write_result_or_throw(::basictl::tl_throwable_ostream & s, std::vector<std::string> & result);
