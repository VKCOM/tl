...
bool Service1AddOrGetReadResult(::tlgen::basictl::tl_istream & s, ::tlgen::service1::AddOrGet& item, ::tlgen::service1::Value& result);
bool Service1AddOrGetWriteResult(::tlgen::basictl::tl_ostream & s, ::tlgen::service1::AddOrGet& item, ::tlgen::service1::Value& result);
