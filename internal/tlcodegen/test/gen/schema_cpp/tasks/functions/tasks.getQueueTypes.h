...
struct GetQueueTypes {
  ...
  bool read_result(::tlgen::basictl::tl_istream & s, std::vector<::tlgen::tasks::QueueTypeInfo> & result) noexcept;
  bool write_result(::tlgen::basictl::tl_ostream & s, std::vector<::tlgen::tasks::QueueTypeInfo> & result) noexcept;

  void read_result(::tlgen::basictl::tl_throwable_istream & s, std::vector<::tlgen::tasks::QueueTypeInfo> & result);
  void write_result(::tlgen::basictl::tl_throwable_ostream & s, std::vector<::tlgen::tasks::QueueTypeInfo> & result);
