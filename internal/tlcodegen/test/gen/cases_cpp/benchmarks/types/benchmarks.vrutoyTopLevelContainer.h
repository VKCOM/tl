...
struct VrutoyTopLevelContainer {
  ::tlgen::benchmarks::VrutoyTopLevelUnion value;

  // tl type info
  static constexpr uint32_t TL_TAG = 0xfb442ca5;
  static constexpr std::string_view TL_NAME = "benchmarks.vrutoyTopLevelContainer";
