...
func init() {
	...
	fillObject(&TLItem{tlName: "benchmarks.VrutoyTopLevelUnion", hasTL1: true, hasTL2: true})
	...
	fillObject(&TLItem{tlName: "cases_bytes.TestEnum", hasTL1: true, hasTL2: true})
	...
	fillObject(&TLItem{tlName: "cases.TestEnum", hasTL1: true, hasTL2: true})
	...
	fillObject(&TLItem{tlName: "cases.TestUnion", hasTL1: true, hasTL2: true})
