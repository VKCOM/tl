...
func (item *CasesTL2TestFixedParam) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTL2TestFixedParam) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("casesTL2.testFixedParam", index)
		}
	}
	if block&2 != 0 {
...
func (item *CasesTL2TestFixedParam) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
