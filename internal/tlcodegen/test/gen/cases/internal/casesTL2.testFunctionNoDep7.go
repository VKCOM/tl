...
func (item *CasesTL2TestFunctionNoDep7) ReadResult(w []byte, ret *CasesTestAllDicts) (_ []byte, err error) {
	return ret.ReadBoxed(w)
}

func (item *CasesTL2TestFunctionNoDep7) WriteResult(w []byte, ret CasesTestAllDicts) (_ []byte, err error) {
	w = ret.WriteBoxed(w)
	return w, nil
}
...
func (item *CasesTL2TestFunctionNoDep7) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret CasesTestAllDicts) ([]int, int) {
...
func (item *CasesTL2TestFunctionNoDep7) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret CasesTestAllDicts) ([]byte, []int, int) {
...
func (item *CasesTL2TestFunctionNoDep7) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret CasesTestAllDicts) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep7) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret CasesTestAllDicts) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep7) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("casesTL2.testFunctionNoDep7", index)
		}
	}
	if block&2 != 0 {
