...
func (item *CasesTL2TestFunctionNoDep7) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *CasesTestAllDicts) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionNoDep7) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret CasesTestAllDicts) []byte {
...
func (item *CasesTL2TestFunctionNoDep7) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret CasesTestAllDicts
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionNoDep7) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CasesTL2TestFunctionNoDep7) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
