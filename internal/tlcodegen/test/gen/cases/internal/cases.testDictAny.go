...
func (item *CasesTestDictAny) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *CasesTestDictAny) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *CasesTestDictAny) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *CasesTestDictAny) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = BuiltinVectorDictionaryAnyFieldDoubleIntCalculateLayout(sizes, true, &item.Dict); sz != 0 {
		currentSize += sz
...
func (item *CasesTestDictAny) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	w = append(w, 0)
	if w, sizes, sz = BuiltinVectorDictionaryAnyFieldDoubleIntInternalWriteTL2(w, sizes, true, &item.Dict); sz != 0 {
		currentBlock |= 2
	}
...
func (item *CasesTestDictAny) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTestDictAny) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("cases.testDictAny", index)
		}
	}
	if block&2 != 0 {
		if currentR, err = BuiltinVectorDictionaryAnyFieldDoubleIntInternalReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		item.Dict = item.Dict[:0]
...
func (item *CasesTestDictAny) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
