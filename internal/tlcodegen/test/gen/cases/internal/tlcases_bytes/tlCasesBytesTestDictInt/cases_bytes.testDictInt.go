...
func (item *CasesBytesTestDictInt) ReadTL2(r []byte) (_ []byte, err error) {
	...
	// read item.Dict
	if block&(1<<1) != 0 {
		if currentR, err = tlBuiltinVectorDictionaryFieldAnyIntInt.BuiltinVectorDictionaryFieldAnyIntIntReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		tlBuiltinVectorDictionaryFieldAnyIntInt.BuiltinVectorDictionaryFieldAnyIntIntReset(item.Dict)
...
func (item *CasesBytesTestDictIntBytes) ReadTL2(r []byte) (_ []byte, err error) {
	...
	// read item.Dict
	if block&(1<<1) != 0 {
		if currentR, err = tlBuiltinVectorDictionaryFieldAnyIntInt.BuiltinVectorDictionaryFieldAnyIntIntBytesReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		item.Dict = item.Dict[:0]
