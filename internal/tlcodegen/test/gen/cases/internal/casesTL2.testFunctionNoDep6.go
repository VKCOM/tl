...
func (item *CasesTL2TestFunctionNoDep6) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret CasesTL2TestArrayFixedBool) ([]int, int) {
...
func (item *CasesTL2TestFunctionNoDep6) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret CasesTL2TestArrayFixedBool) ([]byte, []int, int) {
...
func (item *CasesTL2TestFunctionNoDep6) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret CasesTL2TestArrayFixedBool) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep6) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("casesTL2.testFunctionNoDep6", index)
		}
	}
	if block&2 != 0 {
