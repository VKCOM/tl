...
func (item *CasesTL2TestFunctionNoDep6) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *CasesTL2TestArrayFixedBool) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionNoDep6) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret CasesTL2TestArrayFixedBool) []byte {
...
func (item *CasesTL2TestFunctionNoDep6) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *CasesTL2TestArrayFixedBool) error {
...
func (item *CasesTL2TestFunctionNoDep6) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret CasesTL2TestArrayFixedBool
...
func (item *CasesTL2TestFunctionNoDep6) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret CasesTL2TestArrayFixedBool
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionNoDep6) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CasesTL2TestFunctionNoDep6) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
