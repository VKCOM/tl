...
func (item BenchmarksVrutoyTopLevelContainer) RepairMasksValue() BenchmarksVrutoyTopLevelContainer {
	item.RepairMasks()
	return item
}
...
func (item *BenchmarksVrutoyTopLevelContainer) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *BenchmarksVrutoyTopLevelContainer) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("benchmarks.vrutoyTopLevelContainer", index)
		}
	}
	if block&2 != 0 {
...
func (item *BenchmarksVrutoyTopLevelContainer) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
