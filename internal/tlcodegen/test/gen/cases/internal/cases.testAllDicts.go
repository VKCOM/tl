...
func (item *CasesTestAllDicts) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTestAllDicts) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("cases.testAllDicts", index)
		}
	}
	if block&2 != 0 {
...
func (item *CasesTestAllDicts) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
