...
func (item *CasesTL2TestFunctionNoDep2) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret True) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep2) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("casesTL2.testFunctionNoDep2", index)
		}
	}
	if block&2 != 0 {
