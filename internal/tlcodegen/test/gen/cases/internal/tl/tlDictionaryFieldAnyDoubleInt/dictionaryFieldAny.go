...
func (item *DictionaryFieldAnyDoubleInt) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
...
func (item *DictionaryFieldAnyDoubleInt) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
