...
package tlBuiltinTupleTuple2Int
...
func BuiltinTupleTuple2IntFillRandom(rg *basictl.RandGenerator, vec *[][2]int32, nat_n uint32) {
	rg.IncreaseDepth()
...
func BuiltinTupleTuple2IntRead(w []byte, vec *[][2]int32, nat_n uint32) (_ []byte, err error) {
...
func BuiltinTupleTuple2IntWrite(w []byte, vec [][2]int32, nat_n uint32) (_ []byte, err error) {
...
func BuiltinTupleTuple2IntCalculateLayout(sizes []int, vec *[][2]int32, nat_n uint32) []int {
	currentSize := 0
...
func BuiltinTupleTuple2IntInternalWriteTL2(w []byte, sizes []int, vec *[][2]int32, nat_n uint32) ([]byte, []int) {
	currentSize := sizes[0]
	sizes = sizes[1:]
...
func BuiltinTupleTuple2IntInternalReadTL2(r []byte, vec *[][2]int32, nat_n uint32) (_ []byte, err error) {
	currentSize := 0
...
func BuiltinTupleTuple2IntReadJSON(legacyTypeNames bool, in *basictl.JsonLexer, vec *[][2]int32, nat_n uint32) error {
	if uint32(cap(*vec)) < nat_n {
		*vec = make([][2]int32, nat_n)
	} else {
		*vec = (*vec)[:nat_n]
...
func BuiltinTupleTuple2IntWriteJSON(w []byte, vec [][2]int32, nat_n uint32) (_ []byte, err error) {
	return BuiltinTupleTuple2IntWriteJSONOpt(true, false, w, vec, nat_n)
}
func BuiltinTupleTuple2IntWriteJSONOpt(newTypeNames bool, short bool, w []byte, vec [][2]int32, nat_n uint32) (_ []byte, err error) {
	if uint32(len(vec)) != nat_n {
		return w, internal.ErrorWrongSequenceLength("[][2]int32", len(vec), nat_n)
	}
	w = append(w, '[')
