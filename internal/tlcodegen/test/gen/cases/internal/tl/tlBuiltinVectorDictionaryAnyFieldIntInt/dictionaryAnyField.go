...
func BuiltinVectorDictionaryAnyFieldIntIntCalculateLayout(sizes []int, optimizeEmpty bool, m *map[int32]int32) ([]int, int) {
	...
	for _, key := range keys {
		elem := tlDictionaryAnyFieldIntInt.DictionaryAnyFieldIntInt{Key: key, Value: (*m)[key]}
...
func BuiltinVectorDictionaryAnyFieldIntIntInternalReadTL2(r []byte, m *map[int32]int32) (_ []byte, err error) {
	...
	for i := 0; i < elementCount; i++ {
		elem := tlDictionaryAnyFieldIntInt.DictionaryAnyFieldIntInt{}
...
func BuiltinVectorDictionaryAnyFieldIntIntBytesCalculateLayout(sizes []int, optimizeEmpty bool, vec *[]tlDictionaryAnyFieldIntInt.DictionaryAnyFieldIntInt) ([]int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinVectorDictionaryAnyFieldIntIntBytesInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[]tlDictionaryAnyFieldIntInt.DictionaryAnyFieldIntInt) ([]byte, []int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinVectorDictionaryAnyFieldIntIntBytesInternalReadTL2(r []byte, vec *[]tlDictionaryAnyFieldIntInt.DictionaryAnyFieldIntInt) (_ []byte, err error) {
	currentSize := 0
	if r, currentSize, err = basictl.TL2ParseSize(r); err != nil {
		return r, err
	}
	...
	if cap(*vec) < elementCount {
		*vec = make([]tlDictionaryAnyFieldIntInt.DictionaryAnyFieldIntInt, elementCount)
	}
