...
package tlCasesTL2TestFunctionNoDep7
...
func (item *CasesTL2TestFunctionNoDep7) Read(w []byte) (_ []byte, err error) {
	return basictl.IntRead(w, &item.X)
}

func (item *CasesTL2TestFunctionNoDep7) WriteGeneral(w []byte) (_ []byte, err error) {
	return item.Write(w), nil
}

func (item *CasesTL2TestFunctionNoDep7) Write(w []byte) []byte {
	w = basictl.IntWrite(w, item.X)
	return w
}

func (item *CasesTL2TestFunctionNoDep7) ReadBoxed(w []byte) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep7) WriteBoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteBoxed(w), nil
}

func (item *CasesTL2TestFunctionNoDep7) WriteBoxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x08824518)
	return item.Write(w)
}

func (item *CasesTL2TestFunctionNoDep7) ReadResult(w []byte, ret *tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	return ret.ReadBoxed(w)
}

func (item *CasesTL2TestFunctionNoDep7) WriteResult(w []byte, ret tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	w = ret.WriteBoxed(w)
	return w, nil
}

func (item *CasesTL2TestFunctionNoDep7) ReadResultTL2(r []byte, ctx *basictl.TL2ReadContext, ret *tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionNoDep7) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret tlCasesTestAllDicts.CasesTestAllDicts) ([]int, int) {
	sizes = append(sizes, 142755096)
...
func (item *CasesTL2TestFunctionNoDep7) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret tlCasesTestAllDicts.CasesTestAllDicts) ([]byte, []int, int) {
	if sizes[0] != 142755096 {
...
func (item *CasesTL2TestFunctionNoDep7) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep7) ReadResultJSON(legacyTypeNames bool, in *basictl.JsonLexer, ret *tlCasesTestAllDicts.CasesTestAllDicts) error {
...
func (item *CasesTL2TestFunctionNoDep7) WriteResultJSON(w []byte, ret tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	tctx := basictl.JSONWriteContext{}
	return item.writeResultJSON(&tctx, w, ret)
}

func (item *CasesTL2TestFunctionNoDep7) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	w = ret.WriteJSONOpt(tctx, w)
	return w, nil
}

func (item *CasesTL2TestFunctionNoDep7) FillRandomResult(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret tlCasesTestAllDicts.CasesTestAllDicts
	ret.FillRandom(rg)
	return item.WriteResult(w, ret)
}

func (item *CasesTL2TestFunctionNoDep7) ReadResultWriteResultJSON(tctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlCasesTestAllDicts.CasesTestAllDicts
...
func (item *CasesTL2TestFunctionNoDep7) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlCasesTestAllDicts.CasesTestAllDicts
...
func (item *CasesTL2TestFunctionNoDep7) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	if in != nil {
		...
		for !in.IsDelim('}') {
			...
			case "x":
				if propXPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("casesTL2.testFunctionNoDep7", "x")
				}
				...
				propXPresented = true
			default:
				return internal.ErrorInvalidJSONExcessElement("casesTL2.testFunctionNoDep7", key)
			}
			in.WantComma()
		}
		in.Delim('}')
...
func (item *CasesTL2TestFunctionNoDep7) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("casesTL2.testFunctionNoDep7", err.Error())
	}
	return nil
}
...
func (item *CasesTL2TestFunctionNoDep7) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("casesTL2.testFunctionNoDep7", index)
		}
	}
	if block&2 != 0 {
