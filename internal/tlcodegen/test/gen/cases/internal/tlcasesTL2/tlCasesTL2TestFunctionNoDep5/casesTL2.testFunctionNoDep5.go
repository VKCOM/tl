...
func (item *CasesTL2TestFunctionNoDep5) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlCasesTL2TestObject.CasesTL2TestObject) (_ []byte, err error) {
	var sizes []int
	if ctx != nil {
...
func (item *CasesTL2TestFunctionNoDep5) writeResultJSON(newTypeNames bool, short bool, w []byte, ret tlCasesTL2TestObject.CasesTL2TestObject) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep5) ReadResultWriteResultJSON(r []byte, w []byte) (_ []byte, _ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep5) ReadResultWriteResultJSONOpt(newTypeNames bool, short bool, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlCasesTL2TestObject.CasesTL2TestObject
	if r, err = item.ReadResult(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionNoDep5) WriteJSONGeneral(w []byte) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep5) WriteJSONOpt(newTypeNames bool, short bool, w []byte) (_ []byte, err error) {
	w = append(w, '{')
	backupIndexX := len(w)
...
func (item *CasesTL2TestFunctionNoDep5) CalculateLayout(sizes []int) []int {
...
func (item *CasesTL2TestFunctionNoDep5) InternalWriteTL2(w []byte, sizes []int) ([]byte, []int) {
	currentSize := sizes[0]
	sizes = sizes[1:]
