...
func (item *CasesTL2TestFunctionNoDep5) writeResultTL2(w []byte, sizes []int, ctx *basictl.TL2WriteContext, ret tlCasesTL2TestObject.CasesTL2TestObject) ([]byte, []int, int) {
	currentSize := 1
	lastUsedByte := 0
	var sz int
