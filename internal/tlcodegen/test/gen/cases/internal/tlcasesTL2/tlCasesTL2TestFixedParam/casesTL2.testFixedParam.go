...
package tlCasesTL2TestFixedParam

import (
	"github.com/vkcom/tl/internal/tlcodegen/test/gen/cases/internal"
	"github.com/vkcom/tl/internal/tlcodegen/test/gen/cases/internal/tlcasesTL2/tlCasesTL2TestObjectWithParam4"
...
type CasesTL2TestFixedParam struct {
	X tlCasesTL2TestObjectWithParam4.CasesTL2TestObjectWithParam4
}
...
func (item *CasesTL2TestFixedParam) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("casesTL2.testFixedParam", err.Error())
	}
	return nil
}

func (item *CasesTL2TestFixedParam) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	sizes = append(sizes, 583303831)
...
func (item *CasesTL2TestFixedParam) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("casesTL2.testFixedParam", index)
		}
	}
	if block&2 != 0 {
