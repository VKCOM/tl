...
func (item *CasesTL2TestFunctionWithDep2) writeResultTL2(w []byte, sizes []int, ctx *basictl.TL2WriteContext, ret tlBenchmarksVrutoyPositions.BenchmarksVrutoyPositions) ([]byte, []int, int) {
	currentSize := 1
	lastUsedByte := 0
	var sz int
