...
package tlCasesTL2TestFunctionNoDep2
...
func (item *CasesTL2TestFunctionNoDep2) ReadResult(w []byte, ret *tlTrue.True) (_ []byte, err error) {
	return ret.ReadBoxed(w)
}

func (item *CasesTL2TestFunctionNoDep2) WriteResult(w []byte, ret tlTrue.True) (_ []byte, err error) {
	w = ret.WriteBoxed(w)
	return w, nil
}
...
func (item *CasesTL2TestFunctionNoDep2) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlTrue.True) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep2) WriteResultJSON(w []byte, ret tlTrue.True) (_ []byte, err error) {
	tctx := basictl.JSONWriteContext{}
	return item.writeResultJSON(&tctx, w, ret)
}

func (item *CasesTL2TestFunctionNoDep2) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret tlTrue.True) (_ []byte, err error) {
...
func (item *CasesTL2TestFunctionNoDep2) ReadResultWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlTrue.True
	if r, err = item.ReadResult(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionNoDep2) ReadResultTL2WriteResult(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlTrue.True
...
func (item *CasesTL2TestFunctionNoDep2) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("casesTL2.testFunctionNoDep2", err.Error())
	}
	return nil
}
...
func (item *CasesTL2TestFunctionNoDep2) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("casesTL2.testFunctionNoDep2", index)
		}
	}
	if block&2 != 0 {
