...
func (item *CasesTL2TestFunctionNoDep3) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *[]int32) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionNoDep3) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret []int32) []byte {
...
func (item *CasesTL2TestFunctionNoDep3) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret []int32
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionNoDep3) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CasesTL2TestFunctionNoDep3) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("casesTL2.testFunctionNoDep3", index)
		}
	}
	if block&2 != 0 {
...
func (item *CasesTL2TestFunctionNoDep3) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
