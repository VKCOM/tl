...
func (item *CasesBytesTestDictStringString) Reset() {
	BuiltinVectorDictionaryFieldStringReset(item.Dict)
}

func (item *CasesBytesTestDictStringString) FillRandom(rg *basictl.RandGenerator) {
	BuiltinVectorDictionaryFieldStringFillRandom(rg, &item.Dict)
}

func (item *CasesBytesTestDictStringString) Read(w []byte) (_ []byte, err error) {
	return BuiltinVectorDictionaryFieldStringRead(w, &item.Dict)
}
...
func (item *CasesBytesTestDictStringString) Write(w []byte) []byte {
	w = BuiltinVectorDictionaryFieldStringWrite(w, item.Dict)
	return w
}
	...
	if in != nil {
		...
		for !in.IsDelim('}') {
			...
			case "dict":
				...
				if err := BuiltinVectorDictionaryFieldStringReadJSONGeneral(tctx, in, &item.Dict); err != nil {
					return err
				}
...
func (item *CasesBytesTestDictStringString) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	w = append(w, `"dict":`...)
	w = BuiltinVectorDictionaryFieldStringWriteJSONOpt(tctx, w, item.Dict)
...
func (item *CasesBytesTestDictStringString) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = BuiltinVectorDictionaryFieldStringCalculateLayout(sizes, true, &item.Dict); sz != 0 {
		currentSize += sz
...
func (item *CasesBytesTestDictStringString) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	w = append(w, 0)
	if w, sizes, sz = BuiltinVectorDictionaryFieldStringInternalWriteTL2(w, sizes, true, &item.Dict); sz != 0 {
		currentBlock |= 2
	}
...
func (item *CasesBytesTestDictStringString) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&2 != 0 {
		if currentR, err = BuiltinVectorDictionaryFieldStringInternalReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		BuiltinVectorDictionaryFieldStringReset(item.Dict)
...
func (item *CasesBytesTestDictStringStringBytes) FillRandom(rg *basictl.RandGenerator) {
	BuiltinVectorDictionaryFieldStringBytesFillRandom(rg, &item.Dict)
}

func (item *CasesBytesTestDictStringStringBytes) Read(w []byte) (_ []byte, err error) {
	return BuiltinVectorDictionaryFieldStringBytesRead(w, &item.Dict)
}
...
func (item *CasesBytesTestDictStringStringBytes) Write(w []byte) []byte {
	w = BuiltinVectorDictionaryFieldStringBytesWrite(w, item.Dict)
	return w
}
	...
	if in != nil {
		...
		for !in.IsDelim('}') {
			...
			case "dict":
				...
				if err := BuiltinVectorDictionaryFieldStringBytesReadJSONGeneral(tctx, in, &item.Dict); err != nil {
					return err
				}
				propDictPresented = true
			default:
...
func (item *CasesBytesTestDictStringStringBytes) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	w = basictl.JSONAddCommaIfNeeded(w)
	w = append(w, `"dict":`...)
	w = BuiltinVectorDictionaryFieldStringBytesWriteJSONOpt(tctx, w, item.Dict)
	if (len(item.Dict) != 0) == false {
		w = w[:backupIndexDict]
	}
	return append(w, '}')
...
func (item *CasesBytesTestDictStringStringBytes) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = BuiltinVectorDictionaryFieldStringBytesCalculateLayout(sizes, true, &item.Dict); sz != 0 {
		currentSize += sz
		lastUsedByte = currentSize
	}
...
func (item *CasesBytesTestDictStringStringBytes) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	currentBlockPosition := len(w)
	w = append(w, 0)
	if w, sizes, sz = BuiltinVectorDictionaryFieldStringBytesInternalWriteTL2(w, sizes, true, &item.Dict); sz != 0 {
		currentBlock |= 2
	}
	if currentBlockPosition < len(w) {
		w[currentBlockPosition] = currentBlock
...
func (item *CasesBytesTestDictStringStringBytes) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&2 != 0 {
		if currentR, err = BuiltinVectorDictionaryFieldStringBytesInternalReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		item.Dict = item.Dict[:0]
