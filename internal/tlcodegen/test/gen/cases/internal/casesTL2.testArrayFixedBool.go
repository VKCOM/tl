...
func (item *CasesTL2TestArrayFixedBool) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTL2TestArrayFixedBool) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
