...
func (item *TupleInt2) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTuple2IntCalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTuple2IntInternalWriteTL2(w, sizes, false, ptr)
...
func (item *TupleInt2) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[2]int32)(item)
	if r, err = BuiltinTuple2IntInternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
...
func (item *TupleInt4) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTuple4IntCalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTuple4IntInternalWriteTL2(w, sizes, false, ptr)
...
func (item *TupleInt4) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[4]int32)(item)
	if r, err = BuiltinTuple4IntInternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
...
func (item *TuplePairTupleIntTupleInt2) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTuple2PairTupleIntTupleIntCalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTuple2PairTupleIntTupleIntInternalWriteTL2(w, sizes, false, ptr)
...
func (item *TuplePairTupleIntTupleInt2) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[2]PairTupleIntTupleInt)(item)
	if r, err = BuiltinTuple2PairTupleIntTupleIntInternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
...
func (item *TupleString4) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTuple4StringCalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTuple4StringInternalWriteTL2(w, sizes, false, ptr)
...
func (item *TupleString4) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[4]string)(item)
	if r, err = BuiltinTuple4StringInternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
...
func (item *TupleString4Bytes) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTuple4StringBytesCalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTuple4StringBytesInternalWriteTL2(w, sizes, false, ptr)
...
func (item *TupleString4Bytes) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[4][]byte)(item)
	if r, err = BuiltinTuple4StringBytesInternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
...
func (item *TupleTupleInt2) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTupleTupleInt2CalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTupleTupleInt2InternalWriteTL2(w, sizes, false, ptr)
...
func (item *TupleTupleInt2) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[][2]int32)(item)
	if r, err = BuiltinTupleTupleInt2InternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
...
func (item *TupleTuplePairTupleIntTupleInt2) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	...
	var sz int
	var currentSize int
	sizes, sz = BuiltinTupleTuplePairTupleIntTupleInt2CalculateLayout(sizes, false, ptr)
	currentSize += sz
	w, sizes, _ = BuiltinTupleTuplePairTupleIntTupleInt2InternalWriteTL2(w, sizes, false, ptr)
...
func (item *TupleTuplePairTupleIntTupleInt2) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[][2]PairTupleIntTupleInt)(item)
	if r, err = BuiltinTupleTuplePairTupleIntTupleInt2InternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
