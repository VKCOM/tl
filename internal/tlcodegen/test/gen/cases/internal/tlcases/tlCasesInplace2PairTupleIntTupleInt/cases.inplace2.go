...
func (item *CasesInplace2PairTupleIntTupleInt) ReadJSON(legacyTypeNames bool, in *basictl.JsonLexer, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) error {
	var rawValue []byte
...
func (item *CasesInplace2PairTupleIntTupleInt) WriteJSONGeneral(w []byte, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) (_ []byte, err error) {
...
func (item *CasesInplace2PairTupleIntTupleInt) WriteJSONOpt(newTypeNames bool, short bool, w []byte, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) (_ []byte, err error) {
	w = append(w, '{')
...
func (item *CasesInplace2PairTupleIntTupleInt) CalculateLayout(sizes []int, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) []int {
...
func (item *CasesInplace2PairTupleIntTupleInt) InternalWriteTL2(w []byte, sizes []int, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) ([]byte, []int) {
	currentSize := sizes[0]
	sizes = sizes[1:]
...
func (item *CasesInplace2PairTupleIntTupleInt) WriteTL2(w []byte, ctx *basictl.TL2WriteContext, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) []byte {
	var sizes []int
	if ctx != nil {
...
func (item *CasesInplace2PairTupleIntTupleInt) InternalReadTL2(r []byte, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesInplace2PairTupleIntTupleInt) ReadTL2(r []byte, ctx *basictl.TL2ReadContext, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32, nat_XXn uint32, nat_XYn uint32) (_ []byte, err error) {
