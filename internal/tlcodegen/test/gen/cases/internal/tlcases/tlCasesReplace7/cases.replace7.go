...
func (item *CasesReplace7) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *CasesReplace7) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
	w = append(w, '{')
	backupIndexN := len(w)
...
func (item *CasesReplace7) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	var sizes []int
	if ctx != nil {
...
func (item *CasesReplace7) InternalReadTL2(r []byte) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesReplace7) ReadTL2(r []byte, ctx *basictl.TL2ReadContext) (_ []byte, err error) {
