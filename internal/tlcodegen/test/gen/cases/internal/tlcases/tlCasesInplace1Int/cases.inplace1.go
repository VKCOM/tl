...
func (item *CasesInplace1Int) WriteTL2(w []byte, ctx *basictl.TL2WriteContext, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32) []byte {
	var sizes []int
	if ctx != nil {
...
func (item *CasesInplace1Int) ReadTL2(r []byte, ctx *basictl.TL2ReadContext, nat_a1 uint32, nat_a2 uint32, nat_a3 uint32) (_ []byte, err error) {
