...
import (
	...
	"github.com/vkcom/tl/internal/tlcodegen/test/gen/casesTL2/internal/tl/tlBuiltinTuple4Int"
...
func (item *CasesTestTuple) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = tlBuiltinTuple4Int.BuiltinTuple4IntCalculateLayout(sizes, true, &item.Tpl); sz != 0 {
		currentSize += sz
...
func (item *CasesTestTuple) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	w = append(w, 0)
	if w, sizes, sz = tlBuiltinTuple4Int.BuiltinTuple4IntInternalWriteTL2(w, sizes, true, &item.Tpl); sz != 0 {
		currentBlock |= 2
	}
