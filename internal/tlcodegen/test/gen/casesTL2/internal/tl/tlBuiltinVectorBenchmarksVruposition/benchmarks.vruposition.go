...
func BuiltinVectorBenchmarksVrupositionReadTL1(w []byte, vec *[]tlBenchmarksVruposition.BenchmarksVruposition) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorBenchmarksVrupositionWriteTL1(w []byte, vec []tlBenchmarksVruposition.BenchmarksVruposition) []byte {
...
func BuiltinVectorBenchmarksVrupositionCalculateLayout(sizes []int, optimizeEmpty bool, vec *[]tlBenchmarksVruposition.BenchmarksVruposition) ([]int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinVectorBenchmarksVrupositionInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[]tlBenchmarksVruposition.BenchmarksVruposition) ([]byte, []int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinVectorBenchmarksVrupositionInternalReadTL2(r []byte, vec *[]tlBenchmarksVruposition.BenchmarksVruposition) (_ []byte, err error) {
	currentSize := 0
