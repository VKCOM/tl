...
func (item *BenchmarksVrutoyPositions) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *BenchmarksVrutoyPositions) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
