...
func (item *CasesTL2TestFunctionNoDep5) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *CasesTL2TestObject) error {
...
func (item *CasesTL2TestFunctionNoDep5) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret CasesTL2TestObject
...
func (item *CasesTL2TestFunctionNoDep5) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret CasesTL2TestObject
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
