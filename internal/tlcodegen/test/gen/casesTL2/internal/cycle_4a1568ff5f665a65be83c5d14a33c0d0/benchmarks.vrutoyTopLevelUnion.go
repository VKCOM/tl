...
var _BenchmarksVrutoyTopLevelUnion = [2]internal.UnionElement{
	{TLTag: 0x00000000, TLName: "benchmarks.vrutoytopLevelUnionBig", TLString: "benchmarks.vrutoytopLevelUnionBig#00000000"},
	{TLTag: 0x00000001, TLName: "benchmarks.vrutoytopLevelUnionEmpty", TLString: "benchmarks.vrutoytopLevelUnionEmpty#00000001"},
}

type BenchmarksVrutoyTopLevelUnion struct {
	valueVrutoytopLevelUnionBig BenchmarksVrutoytopLevelUnionBig
	index                       int
}
...
func (item *BenchmarksVrutoyTopLevelUnion) Reset() { item.ResetToVrutoytopLevelUnionBig() }
func (item *BenchmarksVrutoyTopLevelUnion) FillRandom(rg *basictl.RandGenerator) {
	index := basictl.RandomUint(rg) % 2
	switch index {
	case 0:
		item.index = 0
		item.valueVrutoytopLevelUnionBig.FillRandom(rg)
	case 1:
		item.index = 1
	default:
	}
...
func (item *BenchmarksVrutoyTopLevelUnion) IsVrutoytopLevelUnionBig() bool { return item.index == 0 }

func (item *BenchmarksVrutoyTopLevelUnion) AsVrutoytopLevelUnionBig() (*BenchmarksVrutoytopLevelUnionBig, bool) {
	if item.index != 0 {
		return nil, false
	}
	return &item.valueVrutoytopLevelUnionBig, true
}
func (item *BenchmarksVrutoyTopLevelUnion) ResetToVrutoytopLevelUnionBig() *BenchmarksVrutoytopLevelUnionBig {
	item.index = 0
	item.valueVrutoytopLevelUnionBig.Reset()
	return &item.valueVrutoytopLevelUnionBig
}
func (item *BenchmarksVrutoyTopLevelUnion) SetVrutoytopLevelUnionBig(value BenchmarksVrutoytopLevelUnionBig) {
	item.index = 0
	item.valueVrutoytopLevelUnionBig = value
}

func (item *BenchmarksVrutoyTopLevelUnion) IsVrutoytopLevelUnionEmpty() bool { return item.index == 1 }

func (item *BenchmarksVrutoyTopLevelUnion) AsVrutoytopLevelUnionEmpty() (BenchmarksVrutoytopLevelUnionEmpty, bool) {
	var value BenchmarksVrutoytopLevelUnionEmpty
	return value, item.index == 1
}
func (item *BenchmarksVrutoyTopLevelUnion) ResetToVrutoytopLevelUnionEmpty() { item.index = 1 }
func (item *BenchmarksVrutoyTopLevelUnion) SetVrutoytopLevelUnionEmpty()     { item.index = 1 }
...
func (item *BenchmarksVrutoyTopLevelUnion) CalculateLayout(sizes []int) []int {
	switch item.index {
	case 0:
		sizes = item.valueVrutoytopLevelUnionBig.CalculateLayout(sizes)
	case 1:
...
func (item *BenchmarksVrutoyTopLevelUnion) InternalWriteTL2(w []byte, sizes []int) ([]byte, []int) {
	switch item.index {
	case 0:
		w, sizes = item.valueVrutoytopLevelUnionBig.InternalWriteTL2(w, sizes)
	case 1:
		currentSize := sizes[0]
		sizes = sizes[1:]
...
func (item *BenchmarksVrutoyTopLevelUnion) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	switch _tag {
	case "benchmarks.vrutoytopLevelUnionBig":
		item.index = 0
		...
		if err := item.valueVrutoytopLevelUnionBig.ReadJSONGeneral(tctx, in2Pointer); err != nil {
			return err
		}
	case "benchmarks.vrutoytopLevelUnionEmpty":
		item.index = 1
	default:
...
func (item *BenchmarksVrutoyTopLevelUnion) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	case 0:
		...
		w = append(w, `,"value":`...)
		w = item.valueVrutoytopLevelUnionBig.WriteJSONOpt(tctx, w)
		return append(w, '}')
	case 1:
...
func (item BenchmarksVrutoytopLevelUnionBig) AsUnion() BenchmarksVrutoyTopLevelUnion {
	...
	ret.SetVrutoytopLevelUnionBig(item)
	return ret
}
...
func (BenchmarksVrutoytopLevelUnionBig) TLTag() uint32  { return 0x00000000 }
...
func (item BenchmarksVrutoytopLevelUnionEmpty) AsUnion() BenchmarksVrutoyTopLevelUnion {
	var ret BenchmarksVrutoyTopLevelUnion
	ret.SetVrutoytopLevelUnionEmpty()
	return ret
}
...
func (BenchmarksVrutoytopLevelUnionEmpty) TLTag() uint32 { return 0x00000001 }
