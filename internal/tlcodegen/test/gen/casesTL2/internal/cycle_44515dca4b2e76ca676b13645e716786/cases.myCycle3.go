...
type CasesMyCycle3 struct {
	FieldsMask uint32
	a          CasesMyCycle1 // Conditional: item.mask1.2
...
func (item *CasesMyCycle3) IsSetA() bool { return item.mask1&(1<<2) != 0 }
...
func (item *CasesMyCycle3) CalculateLayout(sizes []int) []int {
...
func (item *CasesMyCycle3) InternalWriteTL2(w []byte, sizes []int) ([]byte, []int) {
	currentSize := sizes[0]
	sizes = sizes[1:]
