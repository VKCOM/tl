...
func BuiltinVectorTrueFillRandom(rg *basictl.RandGenerator, vec *[]True) {
	rg.IncreaseDepth()
...
func BuiltinVectorTrueReadTL1(w []byte, vec *[]True) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorTrueWriteTL1(w []byte, vec []True) []byte {
...
func BuiltinVectorTrueCalculateLayout(sizes []int, optimizeEmpty bool, vec *[]True) ([]int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinVectorTrueInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[]True) ([]byte, []int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinVectorTrueInternalReadTL2(r []byte, vec *[]True) (_ []byte, err error) {
	currentSize := 0
