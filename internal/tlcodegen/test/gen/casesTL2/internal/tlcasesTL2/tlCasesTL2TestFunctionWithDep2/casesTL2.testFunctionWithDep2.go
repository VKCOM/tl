...
func (item *CasesTL2TestFunctionWithDep2) Write(w []byte) []byte {
	return item.WriteTL1(w)
}
func (item *CasesTL2TestFunctionWithDep2) WriteTL1(w []byte) []byte {
...
func (item *CasesTL2TestFunctionWithDep2) WriteBoxed(w []byte) []byte {
	return item.WriteTL1Boxed(w)
}
func (item *CasesTL2TestFunctionWithDep2) WriteTL1Boxed(w []byte) []byte {
	panic(basictl.TL2Error("not implemented for tl2 type"))
}
...
func (item *CasesTL2TestFunctionWithDep2) ReadResultTL1(w []byte, ret *tlBenchmarksVrutoyPositions.BenchmarksVrutoyPositions) (_ []byte, err error) {
	return w, basictl.TL2Error("not implemented for tl2 type")
}
...
func (item *CasesTL2TestFunctionWithDep2) WriteResultTL1(w []byte, ret tlBenchmarksVrutoyPositions.BenchmarksVrutoyPositions) (_ []byte, err error) {
	return w, basictl.TL2Error("not implemented for tl2 type")
}
...
func (item *CasesTL2TestFunctionWithDep2) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret tlBenchmarksVrutoyPositions.BenchmarksVrutoyPositions) ([]int, int) {
...
func (item *CasesTL2TestFunctionWithDep2) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret tlBenchmarksVrutoyPositions.BenchmarksVrutoyPositions) ([]byte, []int, int) {
...
func (item *CasesTL2TestFunctionWithDep2) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlBenchmarksVrutoyPositions.BenchmarksVrutoyPositions) []byte {
...
func (item *CasesTL2TestFunctionWithDep2) WriteJSON(w []byte) []byte {
	tctx := basictl.JSONWriteContext{}
	return item.WriteJSONOpt(&tctx, w)
}
func (item *CasesTL2TestFunctionWithDep2) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	if item.N != 0 {
...
func (item *CasesTL2TestFunctionWithDep2) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("casesTL2.testFunctionWithDep2", index)
		}
	}
	if block&2 != 0 {
