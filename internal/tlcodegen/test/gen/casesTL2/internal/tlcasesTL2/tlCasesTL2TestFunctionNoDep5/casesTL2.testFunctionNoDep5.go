...
func (item *CasesTL2TestFunctionNoDep5) ReadResultTL1(w []byte, ret *tlCasesTL2TestObject.CasesTL2TestObject) (_ []byte, err error) {
	return w, basictl.TL2Error("not implemented for tl2 type")
}
...
func (item *CasesTL2TestFunctionNoDep5) WriteResultTL1(w []byte, ret tlCasesTL2TestObject.CasesTL2TestObject) (_ []byte, err error) {
	return w, basictl.TL2Error("not implemented for tl2 type")
}

func (item *CasesTL2TestFunctionNoDep5) ReadResultTL2(r []byte, ctx *basictl.TL2ReadContext, ret *tlCasesTL2TestObject.CasesTL2TestObject) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionNoDep5) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret tlCasesTL2TestObject.CasesTL2TestObject) ([]int, int) {
...
func (item *CasesTL2TestFunctionNoDep5) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret tlCasesTL2TestObject.CasesTL2TestObject) ([]byte, []int, int) {
...
func (item *CasesTL2TestFunctionNoDep5) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlCasesTL2TestObject.CasesTL2TestObject) []byte {
...
func (item *CasesTL2TestFunctionNoDep5) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	if item.X != 0 {
