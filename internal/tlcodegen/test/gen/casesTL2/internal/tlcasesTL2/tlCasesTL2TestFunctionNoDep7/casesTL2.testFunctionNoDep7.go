...
func (item *CasesTL2TestFunctionNoDep7) ReadResultTL1(w []byte, ret *tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	return w, basictl.TL2Error("not implemented for tl2 type")
}
...
func (item *CasesTL2TestFunctionNoDep7) WriteResultTL1(w []byte, ret tlCasesTestAllDicts.CasesTestAllDicts) (_ []byte, err error) {
	return w, basictl.TL2Error("not implemented for tl2 type")
}
