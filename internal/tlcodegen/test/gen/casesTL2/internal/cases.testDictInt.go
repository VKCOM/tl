...
func (item *CasesTestDictInt) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTestDictInt) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
