...
func (CasesBytesTestEnumContainer) TLTag() uint32  { return 0x00000000 }
...
func (item *CasesBytesTestEnumContainer) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *CasesBytesTestEnumContainer) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *CasesBytesTestEnumContainer) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *CasesBytesTestEnumContainer) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesBytesTestEnumContainer) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("cases_bytes.testEnumContainer", index)
		}
	}
	if block&2 != 0 {
...
func (item *CasesBytesTestEnumContainer) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
