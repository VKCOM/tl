...
func (CasesTestEnumContainer) TLTag() uint32  { return 0x00000000 }
...
func (item *CasesTestEnumContainer) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTestEnumContainer) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("cases.testEnumContainer", index)
		}
	}
	if block&2 != 0 {
...
func (item *CasesTestEnumContainer) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
