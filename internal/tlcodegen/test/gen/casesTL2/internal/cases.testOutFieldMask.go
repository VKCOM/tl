...
func (item *CasesTestOutFieldMask) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesTestOutFieldMask) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
