...
func (item *CasesTL2TestFunctionWithDep1) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *[]int32) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionWithDep1) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret []int32) []byte {
...
func (item *CasesTL2TestFunctionWithDep1) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *[]int32) error {
...
func (item *CasesTL2TestFunctionWithDep1) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret []int32
...
func (item *CasesTL2TestFunctionWithDep1) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret []int32
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionWithDep1) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CasesTL2TestFunctionWithDep1) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
