...
func (item *CasesTL2TestFunctionWithDep2) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *BenchmarksVrutoyPositions) (_ []byte, err error) {
	currentSize := 0
...
func (item *CasesTL2TestFunctionWithDep2) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret BenchmarksVrutoyPositions) []byte {
...
func (item *CasesTL2TestFunctionWithDep2) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *BenchmarksVrutoyPositions) error {
...
func (item *CasesTL2TestFunctionWithDep2) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret BenchmarksVrutoyPositions
...
func (item *CasesTL2TestFunctionWithDep2) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret BenchmarksVrutoyPositions
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *CasesTL2TestFunctionWithDep2) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	if item.N != 0 {
...
func (item *CasesTL2TestFunctionWithDep2) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CasesTL2TestFunctionWithDep2) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
