...
type CasesMyCycle3 struct {
	FieldsMask uint32
	A          CasesMyCycle1 // Optional, use SetA
	tl2mask0   byte
}

func (CasesMyCycle3) TLName() string { return "cases.myCycle3" }
func (CasesMyCycle3) TLTag() uint32  { return 0x00000000 }
...
func (item *CasesMyCycle3) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CasesMyCycle3) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
