...
import (
	...
	"github.com/vkcom/tl/internal/tlcodegen/test/gen/casesTL2/internal/tl/tlBuiltinDictStringString"
...
func (item *CasesBytesTestDictStringString) Reset() {
	tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Dict)
}

func (item *CasesBytesTestDictStringString) FillRandom(rg *basictl.RandGenerator) {
	tlBuiltinDictStringString.BuiltinDictStringStringFillRandom(rg, &item.Dict)
}
...
func (item *CasesBytesTestDictStringString) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	if len(item.Dict) != 0 {
		...
		w = append(w, `"dict":`...)
		w = tlBuiltinDictStringString.BuiltinDictStringStringWriteJSONOpt(tctx, w, item.Dict)
	}
	return append(w, '}')
}
...
func (item *CasesBytesTestDictStringString) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringCalculateLayout(sizes, true, &item.Dict); sz != 0 {
		currentSize += sz
...
func (item *CasesBytesTestDictStringString) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	w = append(w, 0)
	if w, sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringInternalWriteTL2(w, sizes, true, &item.Dict); sz != 0 {
		currentBlock |= 2
	}
...
func (item *CasesBytesTestDictStringString) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&2 != 0 {
		if currentR, err = tlBuiltinDictStringString.BuiltinDictStringStringInternalReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Dict)
...
type CasesBytesTestDictStringStringBytes struct {
	Dict []tlDictFieldStringString.DictFieldStringStringBytes
}
...
func (item *CasesBytesTestDictStringStringBytes) FillRandom(rg *basictl.RandGenerator) {
	tlBuiltinDictStringString.BuiltinDictStringStringBytesFillRandom(rg, &item.Dict)
}
...
func (item *CasesBytesTestDictStringStringBytes) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	if len(item.Dict) != 0 {
		w = basictl.JSONAddCommaIfNeeded(w)
		w = append(w, `"dict":`...)
		w = tlBuiltinDictStringString.BuiltinDictStringStringBytesWriteJSONOpt(tctx, w, item.Dict)
	}
	return append(w, '}')
}
...
func (item *CasesBytesTestDictStringStringBytes) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringBytesCalculateLayout(sizes, true, &item.Dict); sz != 0 {
		currentSize += sz
		lastUsedByte = currentSize
	}
...
func (item *CasesBytesTestDictStringStringBytes) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	currentBlockPosition := len(w)
	w = append(w, 0)
	if w, sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringBytesInternalWriteTL2(w, sizes, true, &item.Dict); sz != 0 {
		currentBlock |= 2
	}
	if currentBlockPosition < len(w) {
		w[currentBlockPosition] = currentBlock
...
func (item *CasesBytesTestDictStringStringBytes) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&2 != 0 {
		if currentR, err = tlBuiltinDictStringString.BuiltinDictStringStringBytesInternalReadTL2(currentR, &item.Dict); err != nil {
			return currentR, err
		}
	} else {
		item.Dict = item.Dict[:0]
