...
func init() {
	fillObject(&TLItem{tlName: "benchmarks.vruhash", tag: 0xd31bd0fd, hasTL1: true})
	fillObject(&TLItem{tlName: "benchmarks.vruposition", tag: 0x32792c04, hasTL1: true})
	fillObject(&TLItem{tlName: "benchmarks.vrutoyTopLevelContainer", tag: 0xfb442ca5, hasTL1: true})
	fillObject(&TLItem{tlName: "benchmarks.vrutoyTopLevelContainerWithDependency", tag: 0xc176008e, hasTL1: true})
	fillObject(&TLItem{tlName: "benchmarks.vrutoytopLevelUnionBig", tag: 0xef556bee, hasTL1: true})
	fillObject(&TLItem{tlName: "benchmarks.vrutoytopLevelUnionEmpty", tag: 0xce27c770, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testArray", tag: 0x3762fb81, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testDictAny", tag: 0xee586c08, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testDictInt", tag: 0x453ace07, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testDictString", tag: 0x6c04d6ce, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testDictStringString", tag: 0xad69c772, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testEnum1", tag: 0x58aad3f5, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testEnum2", tag: 0x00b47add, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testEnum3", tag: 0x81911ffa, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testEnumContainer", tag: 0x32b92037, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testTuple", tag: 0x2dd3bacf, hasTL1: true})
	fillObject(&TLItem{tlName: "cases_bytes.testVector", tag: 0x3647c8ae, hasTL1: true})
	fillObject(&TLItem{tlName: "casesGo.testNames", tag: 0x6b61936a, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.myCycle1", tag: 0xd3ca919d, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.myCycle2", tag: 0x5444c9a2, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.myCycle3", tag: 0x7624f86b, hasTL1: true})
	fillObject(&TLItem{tlName: "casesTL2.testArrayFixedBool", tag: 0xf704cf4e, hasTL1: true})
	fillObject(&TLItem{tlName: "casesTL2.testArrayFlexibleBool", tag: 0x974a9b29, hasTL1: true})
	fillObject(&TLItem{tlName: "casesTL2.testFixedParam", tag: 0x22c48297, hasTL1: true})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep1", tag: 0x1b8b9feb, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep2", tag: 0x0a2c0bf9, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep3", tag: 0xf020849b, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep4", tag: 0x5a933a50, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep5", tag: 0x2b47b925, hasTL1: true, annotations: 0x8, resultTypeContainsUnionTypes: true})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep6", tag: 0x9a316c2e, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionNoDep7", tag: 0x08824518, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionWithDep1", tag: 0xb6c63b07, hasTL1: true, annotations: 0x8})
	fillFunction(&TLItem{tlName: "casesTL2.testFunctionWithDep2", tag: 0x9d44a2fd, hasTL1: true, annotations: 0x8})
	fillObject(&TLItem{tlName: "casesTL2.testObject", tag: 0x4f96dd95, hasTL1: true})
	fillObject(&TLItem{tlName: "casesTL2.testParamsGeneration", tag: 0xaac2f033, hasTL1: true})
	fillObject(&TLItem{tlName: "casesTL2.testVectorBool", tag: 0x644bb447, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testAllDicts", tag: 0xec4b79a6, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testAllPossibleFieldConfigsContainer", tag: 0xe3fae936, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testArray", tag: 0xa888030d, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testBeforeReadBitValidation", tag: 0x9b2396db, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testDictAny", tag: 0x252b4ddb, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testDictInt", tag: 0xd3877643, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testDictString", tag: 0xc463c79b, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testEnum1", tag: 0x6c6c55ac, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testEnum2", tag: 0x86ea88ce, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testEnum3", tag: 0x69b83e2f, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testEnumContainer", tag: 0xcb684231, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testInplaceStructArgs", tag: 0xa9e4441e, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testInplaceStructArgs2", tag: 0xaa9f2480, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testLocalFieldmask", tag: 0xf68fd3f9, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testMaybe", tag: 0xd6602613, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testOutFieldMaskContainer", tag: 0x1850ffe4, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testRecursiveFieldMask", tag: 0xc58cf85e, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testTuple", tag: 0x4b9caf8f, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testUnion1", tag: 0x4b4f09b1, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testUnion2", tag: 0x464f96c4, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testUnion3", tag: 0x9b8c9e4c, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testUnion4", tag: 0xd6e28ad9, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testUnionContainer", tag: 0x4497a381, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testVector", tag: 0x4975695c, hasTL1: true})
