...
func init() {
	...
	fillObject(&TLItem{tlName: "cases.testAllPossibleFieldConfigsContainer", tag: 0xb932488a, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testArray", tag: 0xa888030d, hasTL1: true})
	fillObject(&TLItem{tlName: "cases.testBeforeReadBitValidation", tag: 0xc81cf91b, hasTL1: true})
	...
	fillObject(&TLItem{tlName: "cases.testOutFieldMaskContainer", tag: 0x0513c272, hasTL1: true})
