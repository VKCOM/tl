...
func (item *Service1GetExpireTime) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlIntMaybe.IntMaybe) error {
...
func (item *Service1GetExpireTime) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlIntMaybe.IntMaybe) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w)
	return w, nil
}

func (item *Service1GetExpireTime) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
...
func (item *Service1GetExpireTime) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlIntMaybe.IntMaybe
...
func (item *Service1GetExpireTime) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *Service1GetExpireTime) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *Service1GetExpireTime) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
