...
func (item *Service1Exists) ReadResultTL1WriteResultJSON(tctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret bool
...
func (item *Service1Exists) ReadResultJSONWriteResultTL1(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret bool
...
func (item *Service1Exists) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
