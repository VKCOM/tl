...
func (item *Service1Decr) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *Service1Decr) WriteTL1General(w []byte) (_ []byte, err error) {
...
func (item *Service1Decr) WriteTL1(w []byte) []byte {
...
func (item *Service1Decr) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *Service1Decr) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
...
func (item *Service1Decr) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0xeb179ce7)
	return item.WriteTL1(w)
}

func (item *Service1Decr) ReadResult(w []byte, ret *tlService1Value.Service1Value) (_ []byte, err error) {
	return item.ReadResultTL1(w, ret)
}
func (item *Service1Decr) ReadResultTL1(w []byte, ret *tlService1Value.Service1Value) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *Service1Decr) WriteResult(w []byte, ret tlService1Value.Service1Value) (_ []byte, err error) {
	return item.WriteResultTL1(w, ret)
}
func (item *Service1Decr) WriteResultTL1(w []byte, ret tlService1Value.Service1Value) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w)
	return w, nil
}

func (item *Service1Decr) ReadResultJSON(legacyTypeNames bool, in *basictl.JsonLexer, ret *tlService1Value.Service1Value) error {
...
func (item *Service1Decr) WriteResultJSON(w []byte, ret tlService1Value.Service1Value) (_ []byte, err error) {
	tctx := basictl.JSONWriteContext{}
	return item.writeResultJSON(&tctx, w, ret)
}

func (item *Service1Decr) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret tlService1Value.Service1Value) (_ []byte, err error) {
	w = ret.WriteJSONOpt(tctx, w)
	return w, nil
}

func (item *Service1Decr) ReadResultTL1WriteResultJSON(tctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
...
func (item *Service1Decr) ReadResultJSONWriteResultTL1(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlService1Value.Service1Value
...
func (item *Service1Decr) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *Service1Decr) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *Service1Decr) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
