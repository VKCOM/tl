...
func (item *Service1Decr) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlService1Value.Service1Value) error {
...
func (item *Service1Decr) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlService1Value.Service1Value) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w)
	return w, nil
}

func (item *Service1Decr) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
...
func (item *Service1Decr) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlService1Value.Service1Value
...
func (item *Service1Decr) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *Service1Decr) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *Service1Decr) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
