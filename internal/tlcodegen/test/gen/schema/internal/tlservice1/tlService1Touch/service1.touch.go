...
func (item *Service1Touch) ReadResultWriteResultJSON(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret bool
...
func (item *Service1Touch) WriteJSONGeneral(w []byte) (_ []byte, err error) {
