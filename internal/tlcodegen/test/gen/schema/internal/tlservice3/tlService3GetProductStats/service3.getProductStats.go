...
func (item *Service3GetProductStats) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlVectorService3ProductStatsOldMaybe.VectorService3ProductStatsOldMaybe) error {
...
func (item *Service3GetProductStats) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlVectorService3ProductStatsOldMaybe.VectorService3ProductStatsOldMaybe) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w)
	return w, nil
}

func (item *Service3GetProductStats) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
...
func (item *Service3GetProductStats) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlVectorService3ProductStatsOldMaybe.VectorService3ProductStatsOldMaybe
...
func (item *Service3GetProductStats) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *Service3GetProductStats) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *Service3GetProductStats) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
