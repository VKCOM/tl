...
func (item *Service3DeleteAllProducts) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *Service3DeleteAllProducts) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *Service3DeleteAllProducts) WriteTL1(w []byte) []byte {
...
func (item *Service3DeleteAllProducts) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *Service3DeleteAllProducts) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *Service3DeleteAllProducts) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0x4494acc2)
	return item.WriteTL1(w)
}

func (item *Service3DeleteAllProducts) ReadResultTL1(w []byte, ret *bool) (_ []byte, err error) {
	return tlBool.BoolReadTL1Boxed(w, ret)
}

func (item *Service3DeleteAllProducts) WriteResultTL1(w []byte, ret bool) (_ []byte, err error) {
	w = tlBool.BoolWriteTL1Boxed(w, ret)
	return w, nil
}

func (item *Service3DeleteAllProducts) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *bool) error {
...
func (item *Service3DeleteAllProducts) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret bool) (_ []byte, err error) {
	w = basictl.JSONWriteBool(w, ret)
	return w, nil
}

func (item *Service3DeleteAllProducts) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret bool
...
func (item *Service3DeleteAllProducts) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret bool
...
func (item *Service3DeleteAllProducts) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *Service3DeleteAllProducts) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *Service3DeleteAllProducts) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
