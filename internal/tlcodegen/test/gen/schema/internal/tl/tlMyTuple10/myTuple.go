...
func (item *MyTuple10) WriteBoxedGeneral(w []byte) (_ []byte, err error) {
...
func (item *MyTuple10) WriteBoxed(w []byte) []byte {
...
func (item *MyTuple10) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
