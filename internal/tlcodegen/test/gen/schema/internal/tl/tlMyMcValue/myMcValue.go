...
func (item *MyMcValue) ReadTL1(w []byte) (_ []byte, err error) {
	return item.X.ReadTL1Boxed(w)
}

func (item *MyMcValue) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *MyMcValue) WriteTL1(w []byte) []byte {
	w = item.X.WriteTL1Boxed(w)
	return w
}

func (item *MyMcValue) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *MyMcValue) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *MyMcValue) WriteTL1Boxed(w []byte) []byte {
...
func (item *MyMcValue) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *MyMcValue) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *MyMcValue) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
