...
func BuiltinVectorService6FindResultRowReadTL1(w []byte, vec *[]tlService6FindResultRow.Service6FindResultRow) (_ []byte, err error) {
	var l uint32
...
func BuiltinVectorService6FindResultRowWriteTL1(w []byte, vec []tlService6FindResultRow.Service6FindResultRow) []byte {
