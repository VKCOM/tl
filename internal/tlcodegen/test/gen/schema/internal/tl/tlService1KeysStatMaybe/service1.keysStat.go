...
func (item *Service1KeysStatMaybe) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *Service1KeysStatMaybe) WriteTL1Boxed(w []byte) []byte {
	if item.Ok {
...
func (item *Service1KeysStatMaybe) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *Service1KeysStatMaybe) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
