...
func (item *DictionaryDictionaryInt) WriteJSONGeneral(w []byte) (_ []byte, err error) {
...
func (item *DictionaryDictionaryInt) WriteJSONOpt(newTypeNames bool, short bool, w []byte) []byte {
	ptr := (*map[string]map[string]int32)(item)
