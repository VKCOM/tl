...
func BuiltinDictStringDictionaryIntRead(w []byte, m *map[string]map[string]int32) (_ []byte, err error) {
	var l uint32
...
func BuiltinDictStringDictionaryIntWrite(w []byte, m map[string]map[string]int32) []byte {
