...
func (item *TupleIntBoxed10) ptr() *[10]int32 { return (*[10]int32)(item) }
...
func (item *TupleIntBoxed10) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *TupleIntBoxed10) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *TupleIntBoxed10) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
