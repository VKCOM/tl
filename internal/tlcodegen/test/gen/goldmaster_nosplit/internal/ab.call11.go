...
func (item *AbCall11) ReadResultTL2(r []byte, ctx *basictl.TL2ReadContext, ret *AColor) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall11) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret AColor) []byte {
...
func (item *AbCall11) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret AColor) (_ []byte, err error) {
...
func (item *AbCall11) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if ctx != nil {
		sizes = ctx.SizeBuffer[:0]
	}
...
func (item *AbCall11) ReadTL2(r []byte, ctx *basictl.TL2ReadContext) (_ []byte, err error) {
