...
func (item *AbCall11) ReadTL1(w []byte) (_ []byte, err error) {
	return item.X.ReadTL1Boxed(w)
}

func (item *AbCall11) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *AbCall11) WriteTL1(w []byte) []byte {
	w = item.X.WriteTL1Boxed(w)
	return w
}

func (item *AbCall11) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *AbCall11) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *AbCall11) WriteTL1Boxed(w []byte) []byte {
	w = basictl.NatWrite(w, 0xecb2a36c)
	return item.WriteTL1(w)
}

func (item *AbCall11) ReadResultTL1(w []byte, ret *AColor) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *AbCall11) WriteResultTL1(w []byte, ret AColor) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w)
	return w, nil
}

func (item *AbCall11) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *AColor) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall11) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret AColor) ([]int, int) {
...
func (item *AbCall11) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret AColor) ([]byte, []int, int) {
...
func (item *AbCall11) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret AColor) []byte {
...
func (item *AbCall11) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *AColor) error {
...
func (item *AbCall11) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret AColor) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w)
	return w, nil
}

func (item *AbCall11) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret AColor
	ret.FillRandom(rg)
...
func (item *AbCall11) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
...
func (item *AbCall11) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
	if r, err = item.ReadResultTL1(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *AbCall11) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
...
func (item *AbCall11) ReadResultTL2WriteResultJSON(tctx *basictl.TL2ReadContext, jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
	if r, err = item.ReadResultTL2(r, tctx, &ret); err != nil {
		return r, w, err
	}
...
func (item *AbCall11) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *AbCall11) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *AbCall11) InternalReadTL2(r []byte) (_ []byte, err error) {
	currentSize := 0
	if r, currentSize, err = basictl.TL2ParseSize(r); err != nil {
		return r, err
	}
...
func (item *AbCall11) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
