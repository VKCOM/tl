...
func (item *AbCall11) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret AColor) (_ []byte, err error) {
...
func (item *AbCall11) FillRandomResult(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret AColor
	ret.FillRandom(rg)
	return item.WriteResult(w, ret)
}

func (item *AbCall11) ReadResultWriteResultJSON(tctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
...
func (item *AbCall11) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
...
func (item *AbCall11) ReadResultWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
	if r, err = item.ReadResult(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *AbCall11) ReadResultTL2WriteResult(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret AColor
