...
func (item *Service5LongInsert) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *Service5LongOutput) (_ []byte, err error) {
	currentSize := 0
...
func (item *Service5LongInsert) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret Service5LongOutput) ([]int, int) {
...
func (item *Service5LongInsert) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret Service5LongOutput) ([]byte, []int, int) {
...
func (item *Service5LongInsert) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret Service5LongOutput) []byte {
...
func (item *Service5LongInsert) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret Service5LongOutput) (_ []byte, err error) {
