...
func (item *CurlRequest) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *CurlResponse) (_ []byte, err error) {
	currentSize := 0
...
func (item *CurlRequest) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret CurlResponse) []byte {
...
func (item *CurlRequest) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *CurlResponse) error {
