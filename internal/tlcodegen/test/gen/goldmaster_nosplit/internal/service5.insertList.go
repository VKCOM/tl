...
func (item *Service5InsertList) ReadResultTL1(w []byte, ret *ListService5Output) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *Service5InsertList) WriteResultTL1(w []byte, ret ListService5Output) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w)
	return w, nil
}

func (item *Service5InsertList) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *ListService5Output) (_ []byte, err error) {
	currentSize := 0
...
func (item *Service5InsertList) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret ListService5Output) []byte {
...
func (item *Service5InsertList) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *ListService5Output) error {
