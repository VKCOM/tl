...
func (item *AbCall1) ReadResultTL2(w []byte, ret *AbTypeB) (_ []byte, err error) {
...
func (item *AbCall1) WriteResultTL2(w []byte, sizes []int, ret AbTypeB) (_ []byte, _ []int, err error) {
