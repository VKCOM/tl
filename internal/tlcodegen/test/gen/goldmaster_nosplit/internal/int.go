...
func BuiltinTupleTuple3IntCalculateLayout(sizes []int, vec *[][3]int32, nat_n uint32) []int {
	...
	for i := lastIndex; i < nat_n; i++ {
		var elem [3]int32
		currentPosition := len(sizes)
		sizes = BuiltinTuple3IntCalculateLayout(sizes, &elem)
		currentSize += sizes[currentPosition]
		currentSize += basictl.TL2CalculateSize(sizes[currentPosition])
	}
...
func BuiltinTupleTuple3IntInternalWriteTL2(w []byte, sizes []int, vec *[][3]int32, nat_n uint32) ([]byte, []int) {
	...
	for i := lastIndex; i < nat_n; i++ {
		var elem [3]int32
		w, sizes = BuiltinTuple3IntInternalWriteTL2(w, sizes, &elem)
	}
	return w, sizes
}
...
func BuiltinTupleTuple3IntInternalReadTL2(r []byte, vec *[][3]int32, nat_n uint32) (_ []byte, err error) {
	...
	for i := uint32(0); i < lastIndex; i++ {
		if currentR, err = BuiltinTuple3IntInternalReadTL2(currentR, &(*vec)[i]); err != nil {
			return currentR, err
		}
	}
...
func BuiltinTupleTuple3IntWriteJSON(w []byte, vec [][3]int32, nat_n uint32) (_ []byte, err error) {
	tctx := basictl.JSONWriteContext{}
	return BuiltinTupleTuple3IntWriteJSONOpt(&tctx, w, vec, nat_n)
}
func BuiltinTupleTuple3IntWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec [][3]int32, nat_n uint32) (_ []byte, err error) {
	if uint32(len(vec)) != nat_n {
		return w, ErrorWrongSequenceLength("[][3]int32", len(vec), nat_n)
	}
	w = append(w, '[')
	for _, elem := range vec {
		w = basictl.JSONAddCommaIfNeeded(w)
		w = BuiltinTuple3IntWriteJSONOpt(tctx, w, &elem)
	}
	return append(w, ']'), nil
}
...
func BuiltinTupleTupleIntCalculateLayout(sizes []int, vec *[][]int32, nat_n uint32, nat_t uint32) []int {
	...
	for i := lastIndex; i < nat_n; i++ {
		var elem []int32
		currentPosition := len(sizes)
		sizes = BuiltinTupleIntCalculateLayout(sizes, &elem, nat_t)
		currentSize += sizes[currentPosition]
		currentSize += basictl.TL2CalculateSize(sizes[currentPosition])
	}
...
func BuiltinTupleTupleIntInternalWriteTL2(w []byte, sizes []int, vec *[][]int32, nat_n uint32, nat_t uint32) ([]byte, []int) {
	...
	for i := lastIndex; i < nat_n; i++ {
		var elem []int32
		w, sizes = BuiltinTupleIntInternalWriteTL2(w, sizes, &elem, nat_t)
	}
	return w, sizes
}
...
func BuiltinTupleTupleIntInternalReadTL2(r []byte, vec *[][]int32, nat_n uint32, nat_t uint32) (_ []byte, err error) {
	...
	for i := uint32(0); i < lastIndex; i++ {
		if currentR, err = BuiltinTupleIntInternalReadTL2(currentR, &(*vec)[i], nat_t); err != nil {
			return currentR, err
		}
	}
...
func BuiltinTupleTupleIntWriteJSON(w []byte, vec [][]int32, nat_n uint32, nat_t uint32) (_ []byte, err error) {
	tctx := basictl.JSONWriteContext{}
	return BuiltinTupleTupleIntWriteJSONOpt(&tctx, w, vec, nat_n, nat_t)
}
func BuiltinTupleTupleIntWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec [][]int32, nat_n uint32, nat_t uint32) (_ []byte, err error) {
	if uint32(len(vec)) != nat_n {
		return w, ErrorWrongSequenceLength("[][]int32", len(vec), nat_n)
	}
	w = append(w, '[')
	for _, elem := range vec {
		w = basictl.JSONAddCommaIfNeeded(w)
		if w, err = BuiltinTupleIntWriteJSONOpt(tctx, w, elem, nat_t); err != nil {
			return w, err
		}
	}
	return append(w, ']'), nil
...
func BuiltinVectorVectorIntCalculateLayout(sizes []int, vec *[][]int32) []int {
	...
	for i := 0; i < len(*vec); i++ {
		currentPosition := len(sizes)
		elem := (*vec)[i]
		sizes = BuiltinVectorIntCalculateLayout(sizes, &elem)
		currentSize += sizes[currentPosition]
		currentSize += basictl.TL2CalculateSize(sizes[currentPosition])
	}
	sizes[sizePosition] = currentSize
...
func BuiltinVectorVectorIntInternalWriteTL2(w []byte, sizes []int, vec *[][]int32) ([]byte, []int) {
	...
	for i := 0; i < len(*vec); i++ {
		elem := (*vec)[i]
		w, sizes = BuiltinVectorIntInternalWriteTL2(w, sizes, &elem)
	}
	return w, sizes
}
...
func BuiltinVectorVectorIntInternalReadTL2(r []byte, vec *[][]int32) (_ []byte, err error) {
	...
	*vec = (*vec)[:elementCount]
	for i := 0; i < elementCount; i++ {
		if currentR, err = BuiltinVectorIntInternalReadTL2(currentR, &(*vec)[i]); err != nil {
			return currentR, err
		}
	}
	return r, nil
...
func BuiltinVectorVectorIntWriteJSON(w []byte, vec [][]int32) []byte {
	tctx := basictl.JSONWriteContext{}
	return BuiltinVectorVectorIntWriteJSONOpt(&tctx, w, vec)
}
func BuiltinVectorVectorIntWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec [][]int32) []byte {
	w = append(w, '[')
	for _, elem := range vec {
		w = basictl.JSONAddCommaIfNeeded(w)
		w = BuiltinVectorIntWriteJSONOpt(tctx, w, elem)
	}
	return append(w, ']')
}
...
func BuiltinVectorVectorVectorIntCalculateLayout(sizes []int, vec *[][][]int32) []int {
	...
	for i := 0; i < len(*vec); i++ {
		currentPosition := len(sizes)
		elem := (*vec)[i]
		sizes = BuiltinVectorVectorIntCalculateLayout(sizes, &elem)
		currentSize += sizes[currentPosition]
		currentSize += basictl.TL2CalculateSize(sizes[currentPosition])
	}
	sizes[sizePosition] = currentSize
...
func BuiltinVectorVectorVectorIntInternalWriteTL2(w []byte, sizes []int, vec *[][][]int32) ([]byte, []int) {
	...
	for i := 0; i < len(*vec); i++ {
		elem := (*vec)[i]
		w, sizes = BuiltinVectorVectorIntInternalWriteTL2(w, sizes, &elem)
	}
	return w, sizes
}
...
func BuiltinVectorVectorVectorIntInternalReadTL2(r []byte, vec *[][][]int32) (_ []byte, err error) {
	...
	*vec = (*vec)[:elementCount]
	for i := 0; i < elementCount; i++ {
		if currentR, err = BuiltinVectorVectorIntInternalReadTL2(currentR, &(*vec)[i]); err != nil {
			return currentR, err
		}
	}
	return r, nil
...
func BuiltinVectorVectorVectorIntWriteJSON(w []byte, vec [][][]int32) []byte {
	tctx := basictl.JSONWriteContext{}
	return BuiltinVectorVectorVectorIntWriteJSONOpt(&tctx, w, vec)
}
func BuiltinVectorVectorVectorIntWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec [][][]int32) []byte {
	w = append(w, '[')
	for _, elem := range vec {
		w = basictl.JSONAddCommaIfNeeded(w)
		w = BuiltinVectorVectorIntWriteJSONOpt(tctx, w, elem)
	}
	return append(w, ']')
}
