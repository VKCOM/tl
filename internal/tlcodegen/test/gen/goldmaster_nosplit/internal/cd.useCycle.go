...
func (item *CdUseCycle) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *CdUseCycle) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *CdUseCycle) WriteTL1(w []byte) []byte {
	w = item.A.WriteTL1(w)
	w = item.B.WriteTL1Boxed(w)
	return w
}

func (item *CdUseCycle) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *CdUseCycle) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *CdUseCycle) WriteTL1Boxed(w []byte) []byte {
...
func (item *CdUseCycle) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *CdUseCycle) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *CdUseCycle) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *CdUseCycle) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CdUseCycle) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
