...
func (item *Service5Insert) ReadResultTL1(w []byte, ret *Service5Output) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *Service5Insert) WriteResultTL1(w []byte, ret Service5Output) (_ []byte, err error) {
...
func (item *Service5Insert) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret Service5Output) ([]int, int) {
...
func (item *Service5Insert) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret Service5Output) ([]byte, []int, int) {
...
func (item *Service5Insert) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *Service5Output) error {
...
func (item *Service5Insert) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret Service5Output) (_ []byte, err error) {
...
func (item *Service5Insert) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("service5.insert", index)
		}
	}
	item.tl2mask0 = 0
	if block&2 != 0 {
