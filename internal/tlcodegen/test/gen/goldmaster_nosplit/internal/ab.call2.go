...
func (item *AbCall2) ReadResultTL2(r []byte, ctx *basictl.TL2ReadContext, ret *CdTypeB) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall2) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret CdTypeB) []byte {
