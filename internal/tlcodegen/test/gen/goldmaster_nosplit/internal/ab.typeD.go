...
func (item *AbTypeD) ReadTL1(w []byte) (_ []byte, err error) {
	return item.X.ReadTL1(w)
}

func (item *AbTypeD) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *AbTypeD) WriteTL1(w []byte) []byte {
	w = item.X.WriteTL1(w)
	return w
}

func (item *AbTypeD) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *AbTypeD) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *AbTypeD) WriteTL1Boxed(w []byte) []byte {
...
func (item *AbTypeD) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *AbTypeD) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *AbTypeD) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *AbTypeD) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *AbTypeD) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("ab.typeD", index)
		}
	}
	if block&2 != 0 {
...
func (item *AbTypeD) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
