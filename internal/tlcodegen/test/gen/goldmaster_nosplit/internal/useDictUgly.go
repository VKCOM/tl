...
func (item *UseDictUgly) ReadTL2(r []byte) (_ []byte, err error) {
	...
	if currentSize == 0 {
		...
		// read item.A
		if block&(1<<2) != 0 {
			if r, err = BuiltinVectorDictionaryElemUglyIntStringReadTL2(r, &item.A, item.N); err != nil {
				return r, err
			}
		} else {
			item.A = item.A[:0]
		...
		// read item.B
		if block&(1<<3) != 0 {
			if r, err = BuiltinVectorDictionaryElemStrangeStringReadTL2(r, &item.B); err != nil {
				return r, err
			}
		} else {
			BuiltinVectorDictionaryElemStrangeStringReset(item.B)
		...
		// read item.C
		if block&(1<<4) != 0 {
			if r, err = BuiltinVectorDictionaryElemPairIntIntIntReadTL2(r, &item.C); err != nil {
				return r, err
			}
		} else {
			item.C = item.C[:0]
		...
		// read item.D
		if block&(1<<5) != 0 {
			if r, err = BuiltinVectorDictionaryElemTupleStringIntReadTL2(r, &item.D, item.N); err != nil {
				return r, err
			}
		} else {
			item.D = item.D[:0]
		...
		// read item.E
		if block&(1<<6) != 0 {
			if r, err = BuiltinVectorDictionaryElemPairBoolAColorIntReadTL2(r, &item.E); err != nil {
				return r, err
			}
		} else {
			item.E = item.E[:0]
		...
		// read item.F
		if block&(1<<7) != 0 {
			if r, err = BuiltinVectorDictionaryElemPairFloatDoubleIntReadTL2(r, &item.F); err != nil {
				return r, err
			}
		} else {
			item.F = item.F[:0]
		...
		// read item.G
		if block&(1<<0) != 0 {
			if r, err = BuiltinVectorDictionaryElemPairIntPairMultiPointStringIntReadTL2(r, &item.G); err != nil {
				return r, err
			}
		} else {
			item.G = item.G[:0]
		...
		// read item.X
		if block&(1<<1) != 0 {
			if r, err = BuiltinVectorDictionaryElemIntPairIntIntReadTL2(r, &item.X); err != nil {
				return r, err
			}
		} else {
			BuiltinVectorDictionaryElemIntPairIntIntReset(item.X)
		...
		// read item.Y
		if block&(1<<2) != 0 {
			if r, err = BuiltinVectorDictionaryElemLongPairIntIntReadTL2(r, &item.Y); err != nil {
				return r, err
			}
		} else {
			BuiltinVectorDictionaryElemLongPairIntIntReset(item.Y)
		...
		// read item.Z
		if block&(1<<3) != 0 {
			if r, err = BuiltinVectorDictionaryElemStringPairIntIntReadTL2(r, &item.Z); err != nil {
				return r, err
			}
		} else {
			BuiltinVectorDictionaryElemStringPairIntIntReset(item.Z)
