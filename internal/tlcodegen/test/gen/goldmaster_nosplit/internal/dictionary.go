...
type DictionaryPairTupleStringTupleString map[string]PairTupleStringTupleString
...
func (item *DictionaryPairTupleStringTupleString) FillRandom(rg *basictl.RandGenerator, nat_tXn uint32, nat_tYn uint32) {
	ptr := (*map[string]PairTupleStringTupleString)(item)
	BuiltinVectorDictionaryFieldPairTupleStringTupleStringFillRandom(rg, ptr, nat_tXn, nat_tYn)
}

func (item *DictionaryPairTupleStringTupleString) Read(w []byte, nat_tXn uint32, nat_tYn uint32) (_ []byte, err error) {
	ptr := (*map[string]PairTupleStringTupleString)(item)
	return BuiltinVectorDictionaryFieldPairTupleStringTupleStringRead(w, ptr, nat_tXn, nat_tYn)
}
...
func (item *DictionaryPairTupleStringTupleString) Write(w []byte, nat_tXn uint32, nat_tYn uint32) (_ []byte, err error) {
	ptr := (*map[string]PairTupleStringTupleString)(item)
	return BuiltinVectorDictionaryFieldPairTupleStringTupleStringWrite(w, *ptr, nat_tXn, nat_tYn)
}
...
func (item *DictionaryPairTupleStringTupleString) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer, nat_tXn uint32, nat_tYn uint32) error {
	ptr := (*map[string]PairTupleStringTupleString)(item)
	if err := BuiltinVectorDictionaryFieldPairTupleStringTupleStringReadJSONGeneral(tctx, in, ptr, nat_tXn, nat_tYn); err != nil {
		return err
	}
	return nil
}
...
func (item *DictionaryPairTupleStringTupleString) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, nat_tXn uint32, nat_tYn uint32) (_ []byte, err error) {
	ptr := (*map[string]PairTupleStringTupleString)(item)
	if w, err = BuiltinVectorDictionaryFieldPairTupleStringTupleStringWriteJSONOpt(tctx, w, *ptr, nat_tXn, nat_tYn); err != nil {
		return w, err
	}
	return w, nil
}
