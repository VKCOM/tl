...
func (item *AbMyType) ReadTL1(w []byte) (_ []byte, err error) {
	return basictl.IntRead(w, &item.X)
}

func (item *AbMyType) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *AbMyType) WriteTL1(w []byte) []byte {
	w = basictl.IntWrite(w, item.X)
	return w
}

func (item *AbMyType) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *AbMyType) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *AbMyType) WriteTL1Boxed(w []byte) []byte {
...
func (item *AbMyType) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *AbMyType) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *AbMyType) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	backupIndexX := len(w)
...
func (item *AbMyType) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *AbMyType) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, ErrorInvalidUnionIndex("ab.myType", index)
		}
	}
	if block&2 != 0 {
...
func (item *AbMyType) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
...
func (item *AbMyTypeBoxedMaybe) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *AbMyTypeBoxedMaybe) WriteTL1Boxed(w []byte) []byte {
	if item.Ok {
...
func (item *AbMyTypeBoxedMaybe) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
// This method is general version of WriteJSON, use it instead!
func (item *AbMyTypeBoxedMaybe) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
	return item.WriteJSONOpt(jctx, w), nil
}
...
func (item *AbMyTypeBoxedMaybe) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	if !item.Ok {
		return append(w, "{}"...)
	}
	w = append(w, `{"ok":true`...)
...
func (item *AbMyTypeMaybe) ReadTL1Boxed(w []byte) (_ []byte, err error) {
	if w, err = basictl.ReadBool(w, &item.Ok, 0x27930a7b, 0x3f9c8ef8); err != nil {
		return w, err
	}
	if item.Ok {
...
func (item *AbMyTypeMaybe) WriteTL1Boxed(w []byte) []byte {
	if item.Ok {
		w = basictl.NatWrite(w, 0x3f9c8ef8)
...
func (item *AbMyTypeMaybe) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	_ok, _jvalue, err := Json2ReadMaybe("Maybe", in)
	if err != nil {
		return err
	}
...
// This method is general version of WriteJSON, use it instead!
func (item *AbMyTypeMaybe) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
	return item.WriteJSONOpt(jctx, w), nil
}
...
func (item *AbMyTypeMaybe) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	if !item.Ok {
		return append(w, "{}"...)
	}
	w = append(w, `{"ok":true`...)
