 ...
 * @kphp-tl-class
 */
class cases_testEnum1 implements TL\cases\Types\cases_TestEnum, TL\Readable, TL\Writeable {
  ...
  public function write_boxed($stream) {
    $success = $stream->write_uint32(0x6c6c55ac);
    if (!$success) {
      return false;
    }
