 ...
 * @kphp-tl-class
 */
class cases_testEnum2 implements TL\cases\Types\cases_TestEnum, TL\Readable, TL\Writeable {
  ...
  public function write_boxed($stream) {
    $success = $stream->write_uint32(0x86ea88ce);
    if (!$success) {
      return false;
    }
