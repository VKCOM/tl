 ...
 * @kphp-tl-class
 */
class cases_testDictAny implements TL\Readable, TL\Writeable {
  ...
  public function read($stream) {
    ...
    for($i36 = 0; $i36 < $vector_size; $i36++) {
      /** @var TL\_common\Types\dictionaryFieldAny__float__int */
      $obj36 = new TL\_common\Types\dictionaryFieldAny__float__int();
      $success = $obj36->read($stream);
      if (!$success) {
        return false;
      }
      $this->dict[] = $obj36;
  ...
  public function write_boxed($stream) {
    $success = $stream->write_uint32(0xe29b8ae6);
    if (!$success) {
      return false;
    }
