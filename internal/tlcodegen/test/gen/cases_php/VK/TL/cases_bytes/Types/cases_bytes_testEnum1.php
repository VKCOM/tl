 ...
 * @kphp-tl-class
 */
class cases_bytes_testEnum1 implements TL\cases_bytes\Types\cases_bytes_TestEnum, TL\Readable, TL\Writeable {
  ...
  public function write_boxed($stream) {
    $success = $stream->write_uint32(0x58aad3f5);
    if (!$success) {
      return false;
    }
