 ...
 * @kphp-tl-class
 */
class cases_bytes_testDictString implements TL\Readable, TL\Writeable {
  ...
  public function read($stream) {
    ...
    for($i9 = 0; $i9 < $dict_size; $i9++) {
      [$array_int___key, $success] = $stream->read_string();
      if (!$success) {
        return false;
      }
  ...
  public function write_boxed($stream) {
    $success = $stream->write_uint32(0x6c04d6ce);
    if (!$success) {
      return false;
    }
