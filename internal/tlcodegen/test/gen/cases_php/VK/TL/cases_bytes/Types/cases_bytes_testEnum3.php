 ...
 * @kphp-tl-class
 */
class cases_bytes_testEnum3 implements TL\cases_bytes\Types\cases_bytes_TestEnum, TL\Readable, TL\Writeable {
  ...
  public function write_boxed($stream) {
    $success = $stream->write_uint32(0x81911ffa);
    if (!$success) {
      return false;
    }
