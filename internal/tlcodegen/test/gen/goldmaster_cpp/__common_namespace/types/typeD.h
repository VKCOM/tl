...
struct TypeD {
  ...
  // tl type info
  static constexpr uint32_t TL_TAG = 0xb1f4369e;
  static constexpr std::string_view TL_NAME = "typeD";

  uint32_t tl_tag() const { return 0xb1f4369e; }
  std::string_view tl_name() const { return "typeD"; }
