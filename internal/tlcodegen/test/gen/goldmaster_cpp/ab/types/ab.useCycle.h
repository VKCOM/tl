...
struct UseCycle {
  ...
  std::vector<::tlgen::a::Color> b;

  // tl type info
  static constexpr uint32_t TL_TAG = 0x71687381;
  static constexpr std::string_view TL_NAME = "ab.useCycle";

  uint32_t tl_tag() const { return 0x71687381; }
  std::string_view tl_name() const { return "ab.useCycle"; }
