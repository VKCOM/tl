...
bool AbCall3ReadResult(::tlgen::basictl::tl_istream & s, ::tlgen::ab::Call3& item, ::tlgen::TypeB& result);
bool AbCall3WriteResult(::tlgen::basictl::tl_ostream & s, ::tlgen::ab::Call3& item, ::tlgen::TypeB& result);
