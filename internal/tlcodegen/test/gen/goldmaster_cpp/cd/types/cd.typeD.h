...
struct TypeD {
  ...
  // tl type info
  static constexpr uint32_t TL_TAG = 0xb5528285;
  static constexpr std::string_view TL_NAME = "cd.typeD";

  uint32_t tl_tag() const { return 0xb5528285; }
  std::string_view tl_name() const { return "cd.typeD"; }
