...
func (item *Service5Insert) writeResultTL2(w []byte, sizes []int, ctx *basictl.TL2WriteContext, ret cycle_16847572a0831d4cd4c0c0fb513151f3.Service5Output) ([]byte, []int, int) {
	currentSize := 1
	lastUsedByte := 0
	var sz int
