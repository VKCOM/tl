...
func (item *Service5InsertList) ReadResultTL2(r []byte, ctx *basictl.TL2ReadContext, ret *tlListService5Output.ListService5Output) (_ []byte, err error) {
	currentSize := 0
...
func (item *Service5InsertList) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlListService5Output.ListService5Output) []byte {
...
func (item *Service5InsertList) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret tlListService5Output.ListService5Output) (_ []byte, err error) {
...
func (item *Service5InsertList) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
...
func (item *Service5InsertList) ReadResultJSONWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
	if err = item.ReadResultJSON(true, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
