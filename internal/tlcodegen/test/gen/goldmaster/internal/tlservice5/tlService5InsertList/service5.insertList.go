...
func (item Service5InsertList) RepairMasksValue() Service5InsertList {
	item.RepairMasks()
	return item
}
func (item *Service5InsertList) RepairMasks() {
	item.tl2mask0 = 0
	if item.Flags&(1<<0) != 0 {
		item.tl2mask0 |= 1
	}
...
func (item *Service5InsertList) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *tlListService5Output.ListService5Output) (_ []byte, err error) {
	currentSize := 0
...
func (item *Service5InsertList) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret tlListService5Output.ListService5Output) ([]int, int) {
...
func (item *Service5InsertList) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret tlListService5Output.ListService5Output) ([]byte, []int, int) {
...
func (item *Service5InsertList) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret tlListService5Output.ListService5Output) []byte {
...
func (item *Service5InsertList) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlListService5Output.ListService5Output) error {
...
func (item *Service5InsertList) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlListService5Output.ListService5Output) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w)
	return w, nil
}

func (item *Service5InsertList) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
...
func (item *Service5InsertList) ReadResultJSONWriteResultTL1(jctx *basictl.JSONReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
...
func (item *Service5InsertList) ReadResultTL1WriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
	if r, err = item.ReadResultTL1(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *Service5InsertList) ReadResultTL2WriteResultTL1(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
...
func (item *Service5InsertList) ReadResultTL2WriteResultJSON(tctx *basictl.TL2ReadContext, jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
	if r, err = item.ReadResultTL2(r, tctx, &ret); err != nil {
		return r, w, err
	}
...
func (item *Service5InsertList) ReadResultJSONWriteResultTL2(jctx *basictl.JSONReadContext, tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlListService5Output.ListService5Output
	if err = item.ReadResultJSON(jctx, &basictl.JsonLexer{Data: r}, &ret); err != nil {
		return r, w, err
	}
...
func (item *Service5InsertList) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *Service5InsertList) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("service5.insertList", index)
		}
	}
	item.tl2mask0 = 0
	if block&2 != 0 {
...
func (item *Service5InsertList) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
