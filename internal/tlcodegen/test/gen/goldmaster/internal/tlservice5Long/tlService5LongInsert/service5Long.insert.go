...
func (item Service5LongInsert) RepairMasksValue() Service5LongInsert {
	item.RepairMasks()
	return item
}
func (item *Service5LongInsert) RepairMasks() {
	item.tl2mask0 = 0
	if item.Flags&(1<<0) != 0 {
		item.tl2mask0 |= 1
	}
...
func (item *Service5LongInsert) ReadResultTL1(w []byte, ret *tlService5LongOutput.Service5LongOutput) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *Service5LongInsert) WriteResultTL1(w []byte, ret tlService5LongOutput.Service5LongOutput) (_ []byte, err error) {
...
func (item *Service5LongInsert) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret tlService5LongOutput.Service5LongOutput) ([]int, int) {
	sizes = append(sizes, 1622291339)
...
func (item *Service5LongInsert) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret tlService5LongOutput.Service5LongOutput) ([]byte, []int, int) {
	if sizes[0] != 1622291339 {
...
func (item *Service5LongInsert) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlService5LongOutput.Service5LongOutput) error {
...
func (item *Service5LongInsert) WriteResultJSON(w []byte, ret tlService5LongOutput.Service5LongOutput) (_ []byte, err error) {
	return item.writeResultJSON(nil, w, ret)
}

func (item *Service5LongInsert) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlService5LongOutput.Service5LongOutput) (_ []byte, err error) {
	w = ret.WriteJSONOpt(jctx, w)
	return w, nil
}

func (item *Service5LongInsert) FillRandomResultTL1(rg *basictl.RandGenerator, w []byte) ([]byte, error) {
	var ret tlService5LongOutput.Service5LongOutput
	ret.FillRandom(rg)
	return item.WriteResultTL1(w, ret)
}

func (item *Service5LongInsert) ReadResultTL1WriteResultJSON(jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlService5LongOutput.Service5LongOutput
...
func (item *Service5LongInsert) ReadResultTL2WriteResultJSON(tctx *basictl.TL2ReadContext, jctx *basictl.JSONWriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlService5LongOutput.Service5LongOutput
	if r, err = item.ReadResultTL2(r, tctx, &ret); err != nil {
		return r, w, err
	}
...
func (item *Service5LongInsert) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	item.tl2mask0 = 0
...
func (item *Service5LongInsert) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *Service5LongInsert) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *Service5LongInsert) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	sizes = append(sizes, 1622291339)
	sizePosition := len(sizes)
	sizes = append(sizes, 0)
...
func (item *Service5LongInsert) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	if sizes[0] != 1622291339 {
		panic("tl2: tag mismatch between calculate and write")
	}
	currentSize := sizes[1]
...
func (item *Service5LongInsert) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("service5Long.insert", index)
		}
	}
	item.tl2mask0 = 0
	if block&2 != 0 {
