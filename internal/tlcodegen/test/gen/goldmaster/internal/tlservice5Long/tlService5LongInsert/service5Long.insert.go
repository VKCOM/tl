...
func (item *Service5LongInsert) writeResultTL2(w []byte, sizes []int, ctx *basictl.TL2WriteContext, ret cycle_98d4570147919cfd6f6ebfc47c3e10a0.Service5LongOutput) ([]byte, []int, int) {
	currentSize := 1
	lastUsedByte := 0
	var sz int
