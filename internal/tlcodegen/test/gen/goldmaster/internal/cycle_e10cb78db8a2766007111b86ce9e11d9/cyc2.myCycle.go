...
func (item *Cyc2MyCycle) ReadTL1(w []byte) (_ []byte, err error) {
...
func (item *Cyc2MyCycle) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *Cyc2MyCycle) WriteTL1(w []byte) []byte {
...
func (item *Cyc2MyCycle) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *Cyc2MyCycle) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *Cyc2MyCycle) WriteTL1Boxed(w []byte) []byte {
...
func (item *Cyc2MyCycle) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	sizes = append(sizes, 939381675)
...
func (item *Cyc2MyCycle) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	if sizes[0] != 939381675 {
...
func (item *Cyc2MyCycle) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *Cyc2MyCycle) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("cyc2.myCycle", index)
		}
	}
	if block&2 != 0 {
...
func (item *Cyc2MyCycle) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
