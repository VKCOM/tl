...
var _CurlResponse = [2]internal.UnionElement{
...
func (item *CurlResponse) ReadTL1Boxed(w []byte) (_ []byte, err error) {
	...
	case 0x57d7a33a:
		item.index = 0
		return item.valueOk.ReadTL1(w)
	case 0xaf514651:
		item.index = 1
		return item.valueError.ReadTL1(w)
	default:
		return w, internal.ErrorInvalidUnionTag("curl.Response", tag)
	}
}
...
func (item *CurlResponse) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if (block & 1) != 0 {
		...
		if item.index >= 2 {
			return r, internal.ErrorInvalidUnionIndex("curl.Response", item.index)
		}
	}
	switch item.index {
	case 0:
...
func (item *CurlResponse) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *CurlResponse) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) ([]byte, error) {
...
func (item *CurlResponse) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	_tag, _value, err := internal.Json2ReadUnion("curl.Response", in)
	if err != nil {
		return err
	}
	switch _tag {
	case "Ok", "curl.responseOk#57d7a33a", "curl.responseOk", "#57d7a33a":
		if jctx != nil && !jctx.LegacyTypeNames && _tag == "curl.responseOk#57d7a33a" {
			return internal.ErrorInvalidUnionLegacyTagJSON("curl.Response", "curl.responseOk#57d7a33a")
		}
		if jctx != nil && !jctx.LegacyTypeNames && _tag == "#57d7a33a" {
			return internal.ErrorInvalidUnionLegacyTagJSON("curl.Response", "#57d7a33a")
		}
		item.index = 0
	...
	case "Error", "curl.responseError#af514651", "curl.responseError", "#af514651":
		if jctx != nil && !jctx.LegacyTypeNames && _tag == "curl.responseError#af514651" {
			return internal.ErrorInvalidUnionLegacyTagJSON("curl.Response", "curl.responseError#af514651")
		}
		if jctx != nil && !jctx.LegacyTypeNames && _tag == "#af514651" {
			return internal.ErrorInvalidUnionLegacyTagJSON("curl.Response", "#af514651")
		}
		item.index = 1
		var in2Pointer *basictl.JsonLexer
		if _value != nil {
	...
	default:
		return internal.ErrorInvalidUnionTagJSON("curl.Response", _tag)
	}
	return nil
}
...
func (item *CurlResponse) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("curl.Response", err.Error())
	}
	return nil
}
...
func (item *CurlResponseError) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("curl.responseError", err.Error())
	}
	return nil
}
...
func (item *CurlResponseError) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CurlResponseError) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	currentSize := 0
	if r, currentSize, err = basictl.TL2ParseSize(r); err != nil {
		return r, err
	}
...
func (item *CurlResponseOk) Reset() {
	item.FieldMask = 0
	item.HttpCode = 0
	tlBuiltinDictStringString.BuiltinDictStringStringReset(item.HttpHeaders)
	item.HttpBody = ""
	item.tl2mask0 = 0
}
...
func (item *CurlResponseOk) FillRandom(rg *basictl.RandGenerator) {
	...
	tlBuiltinDictStringString.BuiltinDictStringStringFillRandom(rg, &item.HttpHeaders)
...
func (item *CurlResponseOk) ReadTL1(w []byte) (_ []byte, err error) {
	...
	if w, err = tlBuiltinDictStringString.BuiltinDictStringStringReadTL1(w, &item.HttpHeaders); err != nil {
		return w, err
	}
	if item.FieldMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
...
func (item *CurlResponseOk) WriteTL1(w []byte) []byte {
	...
	w = tlBuiltinDictStringString.BuiltinDictStringStringWriteTL1(w, item.HttpHeaders)
	if item.FieldMask&(1<<0) != 0 {
...
func (item *CurlResponseOk) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	if in != nil {
		...
		for !in.IsDelim('}') {
			...
			case "http_headers":
				...
				if err := tlBuiltinDictStringString.BuiltinDictStringStringReadJSONGeneral(jctx, in, &item.HttpHeaders); err != nil {
					return err
				}
			case "http_body":
	...
	if !propHttpBodyPresented && item.FieldMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
	}
	if propHttpBodyPresented {
		item.FieldMask |= 1 << 0
...
func (item *CurlResponseOk) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	w = tlBuiltinDictStringString.BuiltinDictStringStringWriteJSONOpt(jctx, w, item.HttpHeaders)
...
func (item *CurlResponseOk) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("curl.responseOk", err.Error())
	}
	return nil
}
...
func (item *CurlResponseOk) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringCalculateLayout(sizes, true, &item.HttpHeaders); sz != 0 {
		currentSize += sz
		lastUsedByte = currentSize
	}
	if item.tl2mask0&1 != 0 {
...
func (item *CurlResponseOk) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	if w, sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringInternalWriteTL2(w, sizes, true, &item.HttpHeaders); sz != 0 {
		currentBlock |= 8
	}
	if item.tl2mask0&1 != 0 {
...
func (item *CurlResponseOk) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *CurlResponseOk) InternalReadTL2(r []byte, block byte) (_ []byte, err error) {
	...
	if block&8 != 0 {
		if currentR, err = tlBuiltinDictStringString.BuiltinDictStringStringInternalReadTL2(currentR, &item.HttpHeaders); err != nil {
			return currentR, err
		}
	} else {
		tlBuiltinDictStringString.BuiltinDictStringStringReset(item.HttpHeaders)
...
func (item *CurlResponseOk) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	currentSize := 0
	if r, currentSize, err = basictl.TL2ParseSize(r); err != nil {
		return r, err
	}
