...
func (item *CurlRequest) ClearHeaders() {
	tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Headers)
	item.FieldMask &^= 1 << 0
	item.tl2mask0 &^= 1
}
...
func (item *CurlRequest) FillRandom(rg *basictl.RandGenerator) {
	...
	if item.FieldMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
		tlBuiltinDictStringString.BuiltinDictStringStringFillRandom(rg, &item.Headers)
	} else {
		tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Headers)
	}
...
func (item CurlRequest) RepairMasksValue() CurlRequest {
	item.RepairMasks()
	return item
}
func (item *CurlRequest) RepairMasks() {
	item.tl2mask0 = 0
	item.tl2mask1 = 0
	if item.FieldMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
...
func (item *CurlRequest) ReadTL1(w []byte) (_ []byte, err error) {
	...
	if item.FieldMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
		if w, err = tlBuiltinDictStringString.BuiltinDictStringStringReadTL1(w, &item.Headers); err != nil {
			return w, err
		}
	} else {
		tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Headers)
...
func (item *CurlRequest) WriteTL1(w []byte) []byte {
	...
	if item.FieldMask&(1<<0) != 0 {
		w = tlBuiltinDictStringString.BuiltinDictStringStringWriteTL1(w, item.Headers)
	}
	if item.FieldMask&(1<<1) != 0 {
...
func (item *CurlRequest) ReadResultTL1(w []byte, ret *tlCurlResponse.CurlResponse) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *CurlRequest) WriteResultTL1(w []byte, ret tlCurlResponse.CurlResponse) (_ []byte, err error) {
...
func (item *CurlRequest) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlCurlResponse.CurlResponse) (_ []byte, err error) {
...
func (item *CurlRequest) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
		...
		for !in.IsDelim('}') {
			...
			case "field_mask":
				if propFieldMaskPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "field_mask")
				}
			...
			case "method":
				if propMethodPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "method")
				}
				propMethodPresented = true
				if err := internal.Json2ReadString(in, &item.Method); err != nil {
					return err
				}
			case "url":
				if propUrlPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "url")
				}
				propUrlPresented = true
				if err := internal.Json2ReadString(in, &item.Url); err != nil {
					return err
				}
			case "headers":
				if propHeadersPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "headers")
				}
				propHeadersPresented = true
				if err := tlBuiltinDictStringString.BuiltinDictStringStringReadJSONGeneral(jctx, in, &item.Headers); err != nil {
					return err
				}
				item.tl2mask0 |= 1
			case "body":
				if propBodyPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "body")
				}
				propBodyPresented = true
				if err := internal.Json2ReadString(in, &item.Body); err != nil {
					return err
				}
				item.tl2mask0 |= 2
			case "timeout":
				if propTimeoutPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "timeout")
				}
				propTimeoutPresented = true
				if err := internal.Json2ReadInt32(in, &item.Timeout); err != nil {
					return err
				}
				item.tl2mask0 |= 4
			case "timeout_connection":
				if propTimeoutConnectionPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "timeout_connection")
				}
				propTimeoutConnectionPresented = true
				if err := internal.Json2ReadInt32(in, &item.TimeoutConnection); err != nil {
					return err
				}
				item.tl2mask0 |= 8
			case "max_redirs":
				if propMaxRedirsPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "max_redirs")
				}
				propMaxRedirsPresented = true
				if err := internal.Json2ReadInt32(in, &item.MaxRedirs); err != nil {
					return err
				}
				item.tl2mask0 |= 16
			case "ssl_version":
				if propSslVersionPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "ssl_version")
				}
				propSslVersionPresented = true
				if err := internal.Json2ReadInt32(in, &item.SslVersion); err != nil {
					return err
				}
				item.tl2mask0 |= 32
			case "resolve_ipv":
				if propResolveIpvPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "resolve_ipv")
				}
				propResolveIpvPresented = true
				if err := internal.Json2ReadInt32(in, &item.ResolveIpv); err != nil {
					return err
				}
				item.tl2mask0 |= 64
			case "http_proxy":
				if propHttpProxyPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "http_proxy")
				}
				propHttpProxyPresented = true
				if err := internal.Json2ReadString(in, &item.HttpProxy); err != nil {
					return err
				}
				item.tl2mask0 |= 128
			case "limit":
				if propLimitPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "limit")
				}
			...
			case "route":
				if propRoutePresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "route")
				}
				propRoutePresented = true
				if err := internal.Json2ReadString(in, &item.Route); err != nil {
					return err
				}
				item.tl2mask1 |= 2
			case "version":
				if propVersionPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "version")
				}
				propVersionPresented = true
				if err := internal.Json2ReadInt32(in, &item.Version); err != nil {
					return err
				}
				item.tl2mask1 |= 4
			case "origin":
				if propOriginPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "origin")
				}
				propOriginPresented = true
				if err := internal.Json2ReadString(in, &item.Origin); err != nil {
					return err
				}
				item.tl2mask1 |= 8
			case "tls_cert":
				if propTlsCertPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "tls_cert")
				}
				propTlsCertPresented = true
				if err := internal.Json2ReadString(in, &item.TlsCert); err != nil {
					return err
				}
				item.tl2mask1 |= 16
			case "tls_cert_pk":
				if propTlsCertPkPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("curl.request", "tls_cert_pk")
				}
				propTlsCertPkPresented = true
				if err := internal.Json2ReadString(in, &item.TlsCertPk); err != nil {
					return err
				}
				item.tl2mask1 |= 32
			default:
				return internal.ErrorInvalidJSONExcessElement("curl.request", key)
			}
			in.WantComma()
		}
		in.Delim('}')
	...
	if !propHeadersPresented && item.FieldMask&(1<<0) != 0 {
		item.tl2mask0 |= 1
	}
	if !propBodyPresented && item.FieldMask&(1<<1) != 0 {
		item.tl2mask0 |= 2
	}
	if !propTimeoutPresented && item.FieldMask&(1<<2) != 0 {
		item.tl2mask0 |= 4
	}
	if !propTimeoutConnectionPresented && item.FieldMask&(1<<3) != 0 {
		item.tl2mask0 |= 8
	}
	if !propMaxRedirsPresented && item.FieldMask&(1<<4) != 0 {
		item.tl2mask0 |= 16
	}
	if !propSslVersionPresented && item.FieldMask&(1<<5) != 0 {
		item.tl2mask0 |= 32
	}
	if !propResolveIpvPresented && item.FieldMask&(1<<6) != 0 {
		item.tl2mask0 |= 64
	}
	if !propHttpProxyPresented && item.FieldMask&(1<<7) != 0 {
		item.tl2mask0 |= 128
	}
	if !propLimitPresented && item.FieldMask&(1<<8) != 0 {
		item.tl2mask1 |= 1
	}
	if !propRoutePresented && item.FieldMask&(1<<9) != 0 {
		item.tl2mask1 |= 2
	}
	if !propVersionPresented && item.FieldMask&(1<<10) != 0 {
		item.tl2mask1 |= 4
	}
	if !propOriginPresented && item.FieldMask&(1<<11) != 0 {
		item.tl2mask1 |= 8
	}
	if !propTlsCertPresented && item.FieldMask&(1<<12) != 0 {
		item.tl2mask1 |= 16
	}
	if !propTlsCertPkPresented && item.FieldMask&(1<<13) != 0 {
		item.tl2mask1 |= 32
	}
	if propHeadersPresented {
		item.FieldMask |= 1 << 0
...
func (item *CurlRequest) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	if item.tl2mask0&1 != 0 {
		w = basictl.JSONAddCommaIfNeeded(w)
		w = append(w, `"headers":`...)
		w = tlBuiltinDictStringString.BuiltinDictStringStringWriteJSONOpt(jctx, w, item.Headers)
	}
...
func (item *CurlRequest) UnmarshalJSON(b []byte) error {
	...
	if err := item.ReadJSONGeneral(&jctx, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("curl.request", err.Error())
	}
	return nil
}
...
func (item *CurlRequest) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if item.tl2mask0&1 != 0 {
		sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringCalculateLayout(sizes, false, &item.Headers)
		currentSize += sz
		lastUsedByte = currentSize
	}
	if item.tl2mask0&2 != 0 {
...
func (item *CurlRequest) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	if item.tl2mask0&1 != 0 {
		w, sizes, _ = tlBuiltinDictStringString.BuiltinDictStringStringInternalWriteTL2(w, sizes, false, &item.Headers)
		currentBlock |= 16
	}
	if item.tl2mask0&2 != 0 {
...
func (item *CurlRequest) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("curl.request", index)
		}
	}
	item.tl2mask0 = 0
	item.tl2mask1 = 0
	...
	if block&16 != 0 {
		item.tl2mask0 |= 1
		if currentR, err = tlBuiltinDictStringString.BuiltinDictStringStringInternalReadTL2(currentR, &item.Headers); err != nil {
			return currentR, err
		}
	} else {
		tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Headers)
