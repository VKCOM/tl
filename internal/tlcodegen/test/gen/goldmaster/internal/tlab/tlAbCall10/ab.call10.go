...
func (item *AbCall10) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *tlAColor.AColor) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall10) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret tlAColor.AColor) []byte {
...
func (item *AbCall10) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlAColor.AColor) error {
...
func (item *AbCall10) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlAColor.AColor) (_ []byte, err error) {
...
func (item *AbCall10) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("ab.call10", index)
		}
	}
