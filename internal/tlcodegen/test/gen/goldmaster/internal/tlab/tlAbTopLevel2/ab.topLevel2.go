...
func (item *AbTopLevel2) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	if in != nil {
		...
		for !in.IsDelim('}') {
			...
			case "a":
				if propAPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("ab.topLevel2", "a")
				}
				propAPresented = true
			...
			case "b":
				if propBPresented {
					return internal.ErrorInvalidJSONWithDuplicatingKeys("ab.topLevel2", "b")
				}
				propBPresented = true
			...
			default:
				return internal.ErrorInvalidJSONExcessElement("ab.topLevel2", key)
			}
			in.WantComma()
		}
		in.Delim('}')
...
func (item *AbTopLevel2) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *AbTopLevel2) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
...
func (item *AbTopLevel2) UnmarshalJSON(b []byte) error {
	if err := item.ReadJSON(true, &basictl.JsonLexer{Data: b}); err != nil {
		return internal.ErrorInvalidJSON("ab.topLevel2", err.Error())
	}
	return nil
}

func (item *AbTopLevel2) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	sizes = append(sizes, 596347879)
...
func (item *AbTopLevel2) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *AbTopLevel2) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("ab.topLevel2", index)
		}
	}
	if block&2 != 0 {
...
func (item *AbTopLevel2) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	return item.InternalReadTL2(r)
}

type AbTopLevel2Bytes struct {
	A tlNoStr.NoStr
	B tlUseStr.UseStrBytes
}
...
func (item *AbTopLevel2Bytes) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	var propAPresented bool
	var propBPresented bool
	if in != nil {
		in.Delim('{')
...
// This method is general version of WriteJSON, use it instead!
func (item *AbTopLevel2Bytes) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
	return item.WriteJSONOpt(jctx, w), nil
}
...
func (item *AbTopLevel2Bytes) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	w = basictl.JSONAddCommaIfNeeded(w)
	w = append(w, `"a":`...)
	w = item.A.WriteJSONOpt(jctx, w)
...
func (item *AbTopLevel2Bytes) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *AbTopLevel2Bytes) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	return item.InternalReadTL2(r)
}
