...
func (item *AbCall11) ReadResultTL2(r []byte, ctx *basictl.TL2ReadContext, ret *tlAColor.AColor) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall11) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlAColor.AColor) []byte {
