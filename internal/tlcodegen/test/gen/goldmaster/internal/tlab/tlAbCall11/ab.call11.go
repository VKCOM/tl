...
func (item *AbCall11) ReadResultTL1(w []byte, ret *tlAColor.AColor) (_ []byte, err error) {
	return ret.ReadTL1Boxed(w)
}

func (item *AbCall11) WriteResultTL1(w []byte, ret tlAColor.AColor) (_ []byte, err error) {
	w = ret.WriteTL1Boxed(w)
	return w, nil
}

func (item *AbCall11) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *tlAColor.AColor) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall11) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret tlAColor.AColor) []byte {
...
func (item *AbCall11) ReadResultJSON(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, ret *tlAColor.AColor) error {
...
func (item *AbCall11) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("ab.call11", index)
		}
	}
	if block&2 != 0 {
