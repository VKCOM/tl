...
func (item *AbCall9) ReadResultJSONWriteResult(r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlTypeB.TypeB
...
func (item *AbCall9) ReadResultWriteResultTL2(tctx *basictl.TL2WriteContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlTypeB.TypeB
	if r, err = item.ReadResult(r, &ret); err != nil {
		return r, w, err
	}
...
func (item *AbCall9) ReadResultTL2WriteResult(tctx *basictl.TL2ReadContext, r []byte, w []byte) (_ []byte, _ []byte, err error) {
	var ret tlTypeB.TypeB
