...
func (item *AbUseDictString) Reset() {
	item.FieldsMask = 0
	tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Tags)
}
...
func (item *AbUseDictString) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringCalculateLayout(sizes, true, &item.Tags); sz != 0 {
		currentSize += sz
		lastUsedByte = currentSize
	}
...
func (item *AbUseDictString) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	if w, sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringInternalWriteTL2(w, sizes, true, &item.Tags); sz != 0 {
		currentBlock |= 4
	}
...
func (item *AbUseDictString) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *AbUseDictString) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&4 != 0 {
		if currentR, err = tlBuiltinDictStringString.BuiltinDictStringStringInternalReadTL2(currentR, &item.Tags); err != nil {
			return currentR, err
		}
	} else {
		tlBuiltinDictStringString.BuiltinDictStringStringReset(item.Tags)
...
func (item *AbUseDictString) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	return item.InternalReadTL2(r)
}

type AbUseDictStringBytes struct {
	FieldsMask uint32
	Tags       []tlDictFieldStringString.DictFieldStringStringBytes
}
...
func (item *AbUseDictStringBytes) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	...
	if sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringBytesCalculateLayout(sizes, true, &item.Tags); sz != 0 {
		currentSize += sz
		lastUsedByte = currentSize
	}
...
func (item *AbUseDictStringBytes) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	...
	if w, sizes, sz = tlBuiltinDictStringString.BuiltinDictStringStringBytesInternalWriteTL2(w, sizes, true, &item.Tags); sz != 0 {
		currentBlock |= 4
	}
	if currentBlockPosition < len(w) {
		w[currentBlockPosition] = currentBlock
...
func (item *AbUseDictStringBytes) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *AbUseDictStringBytes) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&4 != 0 {
		if currentR, err = tlBuiltinDictStringString.BuiltinDictStringStringBytesInternalReadTL2(currentR, &item.Tags); err != nil {
			return currentR, err
		}
	} else {
		item.Tags = item.Tags[:0]
...
func (item *AbUseDictStringBytes) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	return item.InternalReadTL2(r)
}
