...
func (item *AbCall2) WriteResultTL2(w []byte, ctx *basictl.TL2WriteContext, ret tlCdTypeB.CdTypeB) (_ []byte, err error) {
...
func (item *AbCall2) writeResultJSON(tctx *basictl.JSONWriteContext, w []byte, ret tlCdTypeB.CdTypeB) (_ []byte, err error) {
...
func (item *AbCall2) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *AbCall2) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *AbCall2) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
