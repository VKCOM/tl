...
func (item *AbCall2) ReadResultTL2(r []byte, tctx *basictl.TL2ReadContext, ret *tlCdTypeB.CdTypeB) (_ []byte, err error) {
	currentSize := 0
...
func (item *AbCall2) calculateLayoutResult(sizes []int, optimizeEmpty bool, ret tlCdTypeB.CdTypeB) ([]int, int) {
...
func (item *AbCall2) writeResultTL2(w []byte, sizes []int, optimizeEmpty bool, ret tlCdTypeB.CdTypeB) ([]byte, []int, int) {
...
func (item *AbCall2) WriteResultTL2(w []byte, tctx *basictl.TL2WriteContext, ret tlCdTypeB.CdTypeB) []byte {
...
func (item *AbCall2) writeResultJSON(jctx *basictl.JSONWriteContext, w []byte, ret tlCdTypeB.CdTypeB) (_ []byte, err error) {
...
func (item *AbCall2) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("ab.call2", index)
		}
	}
	if block&2 != 0 {
