...
func (item *CdTypeA) ReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *CdTypeA) WriteJSONGeneral(tctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *CdTypeA) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	backupIndexX := len(w)
...
func (item *CdTypeA) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
...
func (item *CdTypeA) ReadTL2(r []byte, ctx *basictl.TL2ReadContext) (_ []byte, err error) {
