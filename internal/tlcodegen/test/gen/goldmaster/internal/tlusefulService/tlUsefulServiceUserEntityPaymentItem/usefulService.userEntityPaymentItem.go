...
func (item *UsefulServiceUserEntityPaymentItem) WriteTL2(w []byte, ctx *basictl.TL2WriteContext) []byte {
...
func (item *UsefulServiceUserEntityPaymentItem) ReadTL2(r []byte, ctx *basictl.TL2ReadContext) (_ []byte, err error) {
