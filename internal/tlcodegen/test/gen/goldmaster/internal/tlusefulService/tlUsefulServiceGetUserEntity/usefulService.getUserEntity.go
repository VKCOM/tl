...
func (item *UsefulServiceGetUserEntity) writeResultJSON(newTypeNames bool, short bool, w []byte, ret tlUsefulServiceGetUserEntityResultBoxedMaybe.UsefulServiceGetUserEntityResultBoxedMaybe) (_ []byte, err error) {
