...
func (item *TupleCycleTuple) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, nat_n uint32) error {
	if err := cycle_b51088a4226835d54f08524a36f8aa77.BuiltinTupleCycleTupleReadJSONGeneral(jctx, in, item.ptr(), nat_n); err != nil {
		return err
	}
	return nil
}
...
func (item *TupleCycleTuple) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte, nat_n uint32) (_ []byte, err error) {
	if w, err = cycle_b51088a4226835d54f08524a36f8aa77.BuiltinTupleCycleTupleWriteJSONOpt(jctx, w, *item.ptr(), nat_n); err != nil {
		return w, err
	}
	return w, nil
}
