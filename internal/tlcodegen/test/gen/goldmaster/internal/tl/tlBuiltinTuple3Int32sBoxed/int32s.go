...
package tlBuiltinTuple3Int32sBoxed
...
func BuiltinTuple3Int32sBoxedReset(vec *[3]tlInt32s.Int32s) {
	for i := range *vec {
		(*vec)[i].Reset()
	}
}

func BuiltinTuple3Int32sBoxedFillRandom(rg *basictl.RandGenerator, vec *[3]tlInt32s.Int32s) {
	rg.IncreaseDepth()
	for i := range *vec {
		(*vec)[i].FillRandom(rg)
	}
...
func BuiltinTuple3Int32sBoxedCalculateLayout(sizes []int, optimizeEmpty bool, vec *[3]tlInt32s.Int32s) ([]int, int) {
	if 3 == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinTuple3Int32sBoxedInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[3]tlInt32s.Int32s) ([]byte, []int, int) {
	if 3 == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinTuple3Int32sBoxedInternalReadTL2(r []byte, vec *[3]tlInt32s.Int32s) (_ []byte, err error) {
	currentSize := 0
