...
func (item *TestMaybe2) ReadTL1(w []byte) (_ []byte, err error) {
	...
	return item.G.ReadTL1Boxed(w)
}

func (item *TestMaybe2) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *TestMaybe2) WriteTL1(w []byte) []byte {
...
func (item *TestMaybe2) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *TestMaybe2) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *TestMaybe2) WriteTL1Boxed(w []byte) []byte {
...
func (item *TestMaybe2) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *TestMaybe2) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *TestMaybe2) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	backupIndexN := len(w)
...
func (item *TestMaybe2) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *TestMaybe2) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
