...
func (item *TupleIntBoxed0BoxedMaybe) CalculateLayout(sizes []int) []int {
	...
	if item.Ok {
		...
		sizes = tlBuiltinTuple0IntBoxed.BuiltinTuple0IntBoxedCalculateLayout(sizes, &item.Value)
...
func (item *TupleIntBoxed0BoxedMaybe) InternalWriteTL2(w []byte, sizes []int) ([]byte, []int) {
	...
	if item.Ok {
		...
		if sizes[0] != 0 {
			...
			w, sizes = tlBuiltinTuple0IntBoxed.BuiltinTuple0IntBoxedInternalWriteTL2(w, sizes, &item.Value)
		} else {
			sizes = sizes[1:]
		}
	}
