...
func (item *UnionArgsXXX1Int) ReadTL1(w []byte, nat_Y uint32) (_ []byte, err error) {
	return tlBuiltinTupleInt.BuiltinTupleIntReadTL1(w, &item.X, nat_Y)
}

func (item *UnionArgsXXX1Int) WriteTL1(w []byte, nat_Y uint32) (_ []byte, err error) {
	if w, err = tlBuiltinTupleInt.BuiltinTupleIntWriteTL1(w, item.X, nat_Y); err != nil {
		return w, err
	}
	return w, nil
}
...
func (item *UnionArgsXXX1Int) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, nat_Y uint32) error {
	...
	if in != nil {
		...
		for !in.IsDelim('}') {
			...
			case "x":
				...
				propXPresented = true
				if err := tlBuiltinTupleInt.BuiltinTupleIntReadJSONGeneral(jctx, in, &item.X, nat_Y); err != nil {
					return err
				}
			default:
	...
	if !propXPresented {
		if err := tlBuiltinTupleInt.BuiltinTupleIntReadJSONGeneral(jctx, nil, &item.X, nat_Y); err != nil {
			return err
		}
	}
	return nil
...
func (item *UnionArgsXXX1Int) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte, nat_Y uint32) (_ []byte, err error) {
	...
	w = append(w, `"x":`...)
	if w, err = tlBuiltinTupleInt.BuiltinTupleIntWriteJSONOpt(jctx, w, item.X, nat_Y); err != nil {
		return w, err
	}
	if !(len(item.X) != 0) {
		w = w[:backupIndexX]
...
func (item *UnionArgsXXX1Int) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *UnionArgsXXX1Int) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	currentSize := 0
...
func (item *UnionArgsXXX2Int) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *UnionArgsXXX2Int) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
	currentSize := 0
	if r, currentSize, err = basictl.TL2ParseSize(r); err != nil {
		return r, err
	}
...
type UnionArgsXXXInt struct {
	valueV1 UnionArgsXXX1Int
	valueV2 UnionArgsXXX2Int
	index   int
}
...
func (item *UnionArgsXXXInt) Reset() { item.ResetToV1() }
...
func (item *UnionArgsXXXInt) IsV1() bool { return item.index == 0 }

func (item *UnionArgsXXXInt) AsV1() (*UnionArgsXXX1Int, bool) {
	if item.index != 0 {
		return nil, false
	}
	return &item.valueV1, true
}
func (item *UnionArgsXXXInt) ResetToV1() *UnionArgsXXX1Int {
	item.index = 0
	item.valueV1.Reset()
	return &item.valueV1
}
func (item *UnionArgsXXXInt) SetV1(value UnionArgsXXX1Int) {
	item.index = 0
	item.valueV1 = value
}

func (item *UnionArgsXXXInt) IsV2() bool { return item.index == 1 }

func (item *UnionArgsXXXInt) AsV2() (*UnionArgsXXX2Int, bool) {
	if item.index != 1 {
		return nil, false
	}
	return &item.valueV2, true
}
func (item *UnionArgsXXXInt) ResetToV2() *UnionArgsXXX2Int {
	item.index = 1
	item.valueV2.Reset()
	return &item.valueV2
}
func (item *UnionArgsXXXInt) SetV2(value UnionArgsXXX2Int) {
	item.index = 1
	item.valueV2 = value
}
...
func (item *UnionArgsXXXInt) ReadTL1Boxed(w []byte, nat_Y uint32) (_ []byte, err error) {
	...
	case 0xe7978c97:
		item.index = 0
		return item.valueV1.ReadTL1(w, nat_Y)
	case 0x6daed784:
		item.index = 1
		return item.valueV2.ReadTL1(w, nat_Y)
	default:
...
func (item *UnionArgsXXXInt) WriteTL1Boxed(w []byte, nat_Y uint32) (_ []byte, err error) {
	...
	switch item.index {
	case 0:
		if w, err = item.valueV1.WriteTL1(w, nat_Y); err != nil {
			return w, err
		}
	case 1:
		w = item.valueV2.WriteTL1(w, nat_Y)
	}
	return w, nil
}
...
func (item *UnionArgsXXXInt) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes, sizes2 []int
	if tctx != nil {
		sizes = tctx.SizeBuffer[:0]
	}
...
func (item *UnionArgsXXXInt) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) ([]byte, error) {
