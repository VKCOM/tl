...
func BuiltinVectorDictionaryElemPairFloatDoubleIntCalculateLayout(sizes []int, optimizeEmpty bool, vec *[]tlDictionaryElemPairFloatDoubleInt.DictionaryElemPairFloatDoubleInt) ([]int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinVectorDictionaryElemPairFloatDoubleIntInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[]tlDictionaryElemPairFloatDoubleInt.DictionaryElemPairFloatDoubleInt) ([]byte, []int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinVectorDictionaryElemPairFloatDoubleIntInternalReadTL2(r []byte, vec *[]tlDictionaryElemPairFloatDoubleInt.DictionaryElemPairFloatDoubleInt) (_ []byte, err error) {
	currentSize := 0
	...
	if cap(*vec) < elementCount {
		*vec = make([]tlDictionaryElemPairFloatDoubleInt.DictionaryElemPairFloatDoubleInt, elementCount)
	}
...
func BuiltinVectorDictionaryElemPairFloatDoubleIntWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec []tlDictionaryElemPairFloatDoubleInt.DictionaryElemPairFloatDoubleInt) []byte {
	w = append(w, '[')
	for _, elem := range vec {
