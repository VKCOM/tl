...
func BuiltinTupleReplace11ElemLongCalculateLayout(sizes []int, vec *[]tlReplace11ElemLong.Replace11ElemLong, nat_n uint32, nat_tn uint32, nat_tk uint32) []int {
	currentSize := 0
	...
	for i := lastIndex; i < nat_n; i++ {
		var elem tlReplace11ElemLong.Replace11ElemLong
		currentPosition := len(sizes)
...
func BuiltinTupleReplace11ElemLongInternalWriteTL2(w []byte, sizes []int, vec *[]tlReplace11ElemLong.Replace11ElemLong, nat_n uint32, nat_tn uint32, nat_tk uint32) ([]byte, []int) {
	currentSize := sizes[0]
	sizes = sizes[1:]
...
func BuiltinTupleReplace11ElemLongInternalReadTL2(r []byte, vec *[]tlReplace11ElemLong.Replace11ElemLong, nat_n uint32, nat_tn uint32, nat_tk uint32) (_ []byte, err error) {
	currentSize := 0
...
func BuiltinTupleReplace11ElemLongWriteJSON(w []byte, vec []tlReplace11ElemLong.Replace11ElemLong, nat_n uint32, nat_tn uint32, nat_tk uint32) (_ []byte, err error) {
	...
	return BuiltinTupleReplace11ElemLongWriteJSONOpt(&tctx, w, vec, nat_n, nat_tn, nat_tk)
}
func BuiltinTupleReplace11ElemLongWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec []tlReplace11ElemLong.Replace11ElemLong, nat_n uint32, nat_tn uint32, nat_tk uint32) (_ []byte, err error) {
	if uint32(len(vec)) != nat_n {
		return w, internal.ErrorWrongSequenceLength("[]tlReplace11ElemLong.Replace11ElemLong", len(vec), nat_n)
	}
	w = append(w, '[')
