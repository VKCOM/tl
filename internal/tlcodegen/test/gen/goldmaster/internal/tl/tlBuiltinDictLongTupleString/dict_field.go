...
package tlBuiltinDictLongTupleString
...
func BuiltinDictLongTupleStringCalculateLayout(sizes []int, optimizeEmpty bool, m *map[int64][]string) ([]int, int) {
	...
	for _, key := range keys {
		elem := tlDictFieldLongTupleString.DictFieldLongTupleString{Key: key, Value: (*m)[key]}
...
func BuiltinDictLongTupleStringInternalReadTL2(r []byte, m *map[int64][]string) (_ []byte, err error) {
	...
	for i := 0; i < elementCount; i++ {
		elem := tlDictFieldLongTupleString.DictFieldLongTupleString{}
