...
func (item *TupleInt3Maybe) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
	...
	if _ok {
		...
		if err := tlBuiltinTuple3Int.BuiltinTuple3IntReadJSONGeneral(jctx, in2Pointer, &item.Value); err != nil {
			return err
		}
	}
	return nil
...
func (item *TupleInt3Maybe) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	...
	w = append(w, `{"ok":true`...)
	w = append(w, `,"value":`...)
	w = tlBuiltinTuple3Int.BuiltinTuple3IntWriteJSONOpt(jctx, w, &item.Value)
	return append(w, '}')
}
