...
func (item *NoStr) ReadTL1(w []byte) (_ []byte, err error) {
	return basictl.IntRead(w, &item.X)
}

func (item *NoStr) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *NoStr) WriteTL1(w []byte) []byte {
	w = basictl.IntWrite(w, item.X)
	return w
}

func (item *NoStr) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *NoStr) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *NoStr) WriteTL1Boxed(w []byte) []byte {
...
func (item *NoStr) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *NoStr) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *NoStr) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	backupIndexX := len(w)
...
func (item *NoStr) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *NoStr) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
