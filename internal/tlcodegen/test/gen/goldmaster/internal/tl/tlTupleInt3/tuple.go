...
func (item *TupleInt3) WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte) []byte {
	ptr := (*[3]int32)(item)
	w = tlBuiltinTuple3Int.BuiltinTuple3IntWriteJSONOpt(tctx, w, ptr)
	return w
}
...
func (item *TupleInt3) CalculateLayout(sizes []int) []int {
	ptr := (*[3]int32)(item)
	sizes = tlBuiltinTuple3Int.BuiltinTuple3IntCalculateLayout(sizes, ptr)
	return sizes
}

func (item *TupleInt3) InternalWriteTL2(w []byte, sizes []int) ([]byte, []int) {
	ptr := (*[3]int32)(item)
	w, sizes = tlBuiltinTuple3Int.BuiltinTuple3IntInternalWriteTL2(w, sizes, ptr)
	return w, sizes
}
...
func (item *TupleInt3) InternalReadTL2(r []byte) (_ []byte, err error) {
	ptr := (*[3]int32)(item)
	if r, err = tlBuiltinTuple3Int.BuiltinTuple3IntInternalReadTL2(r, ptr); err != nil {
		return r, err
	}
	return r, nil
}
