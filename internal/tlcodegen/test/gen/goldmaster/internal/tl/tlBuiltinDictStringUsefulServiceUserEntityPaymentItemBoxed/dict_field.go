...
package tlBuiltinDictStringUsefulServiceUserEntityPaymentItemBoxed
...
func BuiltinDictStringUsefulServiceUserEntityPaymentItemBoxedReset(m map[string]tlUsefulServiceUserEntityPaymentItem.UsefulServiceUserEntityPaymentItem) {
	clear(m)
}

func BuiltinDictStringUsefulServiceUserEntityPaymentItemBoxedFillRandom(rg *basictl.RandGenerator, m *map[string]tlUsefulServiceUserEntityPaymentItem.UsefulServiceUserEntityPaymentItem, nat_t uint32) {
	rg.IncreaseDepth()
...
func BuiltinDictStringUsefulServiceUserEntityPaymentItemBoxedCalculateLayout(sizes []int, optimizeEmpty bool, m *map[string]tlUsefulServiceUserEntityPaymentItem.UsefulServiceUserEntityPaymentItem) ([]int, int) {
	if len(*m) == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
	...
	for _, key := range keys {
		elem := tlDictFieldStringUsefulServiceUserEntityPaymentItemBoxed.DictFieldStringUsefulServiceUserEntityPaymentItemBoxed{Key: key, Value: (*m)[key]}
...
func BuiltinDictStringUsefulServiceUserEntityPaymentItemBoxedInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, m *map[string]tlUsefulServiceUserEntityPaymentItem.UsefulServiceUserEntityPaymentItem) ([]byte, []int, int) {
	if len(*m) == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinDictStringUsefulServiceUserEntityPaymentItemBoxedInternalReadTL2(r []byte, m *map[string]tlUsefulServiceUserEntityPaymentItem.UsefulServiceUserEntityPaymentItem) (_ []byte, err error) {
	currentSize := 0
	...
	for i := 0; i < elementCount; i++ {
		elem := tlDictFieldStringUsefulServiceUserEntityPaymentItemBoxed.DictFieldStringUsefulServiceUserEntityPaymentItemBoxed{}
