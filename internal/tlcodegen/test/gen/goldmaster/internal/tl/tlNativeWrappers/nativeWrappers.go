...
func (item *NativeWrappers) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *NativeWrappers) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("nativeWrappers", index)
		}
	}
	if block&2 != 0 {
...
func (item *NativeWrappers) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
