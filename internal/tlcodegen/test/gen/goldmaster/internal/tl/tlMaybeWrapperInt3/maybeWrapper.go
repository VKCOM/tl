...
func (item *MaybeWrapperInt3) ReadTL1(w []byte) (_ []byte, err error) {
	return item.A.ReadTL1Boxed(w)
}

func (item *MaybeWrapperInt3) WriteTL1General(w []byte) (_ []byte, err error) {
	return item.WriteTL1(w), nil
}

func (item *MaybeWrapperInt3) WriteTL1(w []byte) []byte {
	w = item.A.WriteTL1Boxed(w)
	return w
}

func (item *MaybeWrapperInt3) ReadTL1Boxed(w []byte) (_ []byte, err error) {
...
func (item *MaybeWrapperInt3) WriteTL1BoxedGeneral(w []byte) (_ []byte, err error) {
	return item.WriteTL1Boxed(w), nil
}

func (item *MaybeWrapperInt3) WriteTL1Boxed(w []byte) []byte {
...
func (item *MaybeWrapperInt3) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer) error {
...
func (item *MaybeWrapperInt3) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte) (_ []byte, err error) {
...
func (item *MaybeWrapperInt3) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte) []byte {
	w = append(w, '{')
	backupIndexA := len(w)
...
func (item *MaybeWrapperInt3) CalculateLayout(sizes []int, optimizeEmpty bool) ([]int, int) {
	sizes = append(sizes, 3756361377)
...
func (item *MaybeWrapperInt3) InternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool) ([]byte, []int, int) {
	if sizes[0] != 3756361377 {
...
func (item *MaybeWrapperInt3) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
...
func (item *MaybeWrapperInt3) InternalReadTL2(r []byte) (_ []byte, err error) {
	...
	if block&1 != 0 {
		...
		if index != 0 {
			return r, internal.ErrorInvalidUnionIndex("maybeWrapper", index)
		}
	}
	if block&2 != 0 {
...
func (item *MaybeWrapperInt3) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
