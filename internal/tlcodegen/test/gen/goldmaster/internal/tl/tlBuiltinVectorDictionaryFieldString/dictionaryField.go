...
func BuiltinVectorDictionaryFieldStringBytesCalculateLayout(sizes []int, optimizeEmpty bool, vec *[]tlDictionaryFieldString.DictionaryFieldStringBytes) ([]int, int) {
...
func BuiltinVectorDictionaryFieldStringBytesInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[]tlDictionaryFieldString.DictionaryFieldStringBytes) ([]byte, []int, int) {
	if len(*vec) == 0 && optimizeEmpty {
		return w, sizes, 0
	}
	currentSize := sizes[0]
