...
func BuiltinDictIntPairIntIntRead(w []byte, m *map[int32]tlPairIntInt.PairIntInt) (_ []byte, err error) {
	var l uint32
...
func BuiltinDictIntPairIntIntWrite(w []byte, m map[int32]tlPairIntInt.PairIntInt) []byte {
