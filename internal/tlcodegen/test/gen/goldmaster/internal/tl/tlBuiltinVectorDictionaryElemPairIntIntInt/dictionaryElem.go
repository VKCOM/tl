...
func BuiltinVectorDictionaryElemPairIntIntIntCalculateLayout(sizes []int, optimizeEmpty bool, vec *[]tlDictionaryElemPairIntIntInt.DictionaryElemPairIntIntInt) ([]int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinVectorDictionaryElemPairIntIntIntInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[]tlDictionaryElemPairIntIntInt.DictionaryElemPairIntIntInt) ([]byte, []int, int) {
	if len(*vec) == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinVectorDictionaryElemPairIntIntIntReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer, vec *[]tlDictionaryElemPairIntIntInt.DictionaryElemPairIntIntInt) error {
	*vec = (*vec)[:cap(*vec)]
	index := 0
	if in != nil {
		in.Delim('[')
...
func BuiltinVectorDictionaryElemPairIntIntIntWriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec []tlDictionaryElemPairIntIntInt.DictionaryElemPairIntIntInt) []byte {
	w = append(w, '[')
	for _, elem := range vec {
