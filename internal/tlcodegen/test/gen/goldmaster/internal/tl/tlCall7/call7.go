...
func (item *Call7) ReadResultTL2(w []byte, ret *tlAbTypeB.AbTypeB) (_ []byte, err error) {
...
func (item *Call7) WriteResultTL2(w []byte, sizes []int, ret tlAbTypeB.AbTypeB) (_ []byte, _ []int, err error) {
...
func (item *Call7) WriteTL2(w []byte, sizes []int) ([]byte, []int) {
	sizes = item.CalculateLayout(sizes[:0])
	w, _ = item.InternalWriteTL2(w, sizes)
	return w, sizes[:0]
}

func (item *Call7) ReadTL2(r []byte) (_ []byte, err error) {
	currentSize := 0
