...
package tlIntKeyDictionaryTupleString
...
func (item *IntKeyDictionaryTupleString) Reset() {
	tlBuiltinDictIntTupleString.BuiltinDictIntTupleStringReset(*item.ptr())
}
...
func (item *IntKeyDictionaryTupleString) ReadJSONGeneral(jctx *basictl.JSONReadContext, in *basictl.JsonLexer, nat_t uint32) error {
	if err := tlBuiltinDictIntTupleString.BuiltinDictIntTupleStringReadJSONGeneral(jctx, in, item.ptr(), nat_t); err != nil {
		return err
	}
	return nil
}
...
func (item *IntKeyDictionaryTupleString) WriteJSONGeneral(jctx *basictl.JSONWriteContext, w []byte, nat_t uint32) (_ []byte, err error) {
...
func (item *IntKeyDictionaryTupleString) WriteJSONOpt(jctx *basictl.JSONWriteContext, w []byte, nat_t uint32) (_ []byte, err error) {
	if w, err = tlBuiltinDictIntTupleString.BuiltinDictIntTupleStringWriteJSONOpt(jctx, w, *item.ptr(), nat_t); err != nil {
		return w, err
	}
	return w, nil
}

func (item *IntKeyDictionaryTupleString) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes []int
	if tctx != nil {
	...
	var sz int
	var currentSize int
	sizes, sz = tlBuiltinDictIntTupleString.BuiltinDictIntTupleStringCalculateLayout(sizes, false, item.ptr())
	currentSize += sz
	w, sizes, _ = tlBuiltinDictIntTupleString.BuiltinDictIntTupleStringInternalWriteTL2(w, sizes, false, item.ptr())
...
func (item *IntKeyDictionaryTupleString) InternalReadTL2(r []byte) (_ []byte, err error) {
	if r, err = tlBuiltinDictIntTupleString.BuiltinDictIntTupleStringInternalReadTL2(r, item.ptr()); err != nil {
		return r, err
	}
	return r, nil
}

func (item *IntKeyDictionaryTupleString) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
