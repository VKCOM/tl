...
func BuiltinTupleReplace15Elem2CalculateLayout(sizes []int, vec *[]tlReplace15Elem2.Replace15Elem2, nat_n uint32, nat_t uint32) []int {
	...
	for i := lastIndex; i < nat_n; i++ {
		var elem tlReplace15Elem2.Replace15Elem2
		currentPosition := len(sizes)
...
func BuiltinTupleReplace15Elem2InternalReadTL2(r []byte, vec *[]tlReplace15Elem2.Replace15Elem2, nat_n uint32, nat_t uint32) (_ []byte, err error) {
	currentSize := 0
...
func BuiltinTupleReplace15Elem2WriteJSONOpt(tctx *basictl.JSONWriteContext, w []byte, vec []tlReplace15Elem2.Replace15Elem2, nat_n uint32, nat_t uint32) (_ []byte, err error) {
	if uint32(len(vec)) != nat_n {
		return w, internal.ErrorWrongSequenceLength("[]tlReplace15Elem2.Replace15Elem2", len(vec), nat_n)
	}
	w = append(w, '[')
