...
func (item *MyInt64) ptr() *tlInt64s.Int64s { return (*tlInt64s.Int64s)(item) }
...
func (item *MyInt64) WriteTL2(w []byte, tctx *basictl.TL2WriteContext) []byte {
	var sizes []int
	if tctx != nil {
...
func (item *MyInt64) ReadTL2(r []byte, tctx *basictl.TL2ReadContext) (_ []byte, err error) {
