...
func BuiltinTuple3Int32BoxedCalculateLayout(sizes []int, optimizeEmpty bool, vec *[3]tlInt32.Int32) ([]int, int) {
	if 3 == 0 {
		if optimizeEmpty {
			return sizes, 0
		}
...
func BuiltinTuple3Int32BoxedInternalWriteTL2(w []byte, sizes []int, optimizeEmpty bool, vec *[3]tlInt32.Int32) ([]byte, []int, int) {
	if 3 == 0 {
		if optimizeEmpty {
			return w, sizes, 0
		}
...
func BuiltinTuple3Int32BoxedReadJSONGeneral(tctx *basictl.JSONReadContext, in *basictl.JsonLexer, vec *[3]tlInt32.Int32) error {
	index := 0
	if in != nil {
		in.Delim('[')
		if !in.Ok() {
