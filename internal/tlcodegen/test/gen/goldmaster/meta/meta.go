...
func init() {
	...
	fillObject("replace#ebb26b29", "#ebb26b29", &TLItem{tag: 0xebb26b29, annotations: 0x0, tlName: "replace", resultTypeContainsUnionTypes: false, argumentsTypesContainUnionTypes: false})
