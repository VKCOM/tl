...
func init() {
	...
	fillFunction("ab.call3#0a083445", "#0a083445", &TLItem{tag: 0xa083445, annotations: 0x1, tlName: "ab.call3"})
	...
	fillObject("multiPoint#0e1ae81e", "#0e1ae81e", &TLItem{tag: 0xe1ae81e, annotations: 0x0, tlName: "multiPoint"})
	...
	fillObject("testMaybe2#0aa03cf2", "#0aa03cf2", &TLItem{tag: 0xaa03cf2, annotations: 0x0, tlName: "testMaybe2"})
	...
	fillObject("useResponse#0a63ec5f", "#0a63ec5f", &TLItem{tag: 0xa63ec5f, annotations: 0x0, tlName: "useResponse"})
