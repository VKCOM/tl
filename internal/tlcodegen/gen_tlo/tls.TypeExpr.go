...
func (item *TlsArray) Read(w []byte) (_ []byte, err error) {
	...
	if w, err = NatRead(w, &item.ArgsNum); err != nil {
		return w, err
	}
	return TupleTlsArgBoxedRead(w, &item.Args, item.ArgsNum)
}
...
func (item *TlsArray) Write(w []byte) (_ []byte, err error) {
	...
	w = NatWrite(w, item.ArgsNum)
	return TupleTlsArgBoxedWrite(w, item.Args, item.ArgsNum)
}

func (item *TlsArray) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = NatReadExactTag(w, 0xd9fb20de); err != nil {
		return w, err
	}
	return item.Read(w)
}
...
func (item *TlsArray) readJSON(j interface{}) error {
	...
	if err := TupleTlsArgBoxedReadJSON(_jArgs, &item.Args, item.ArgsNum); err != nil {
		return err
	}
	return nil
}
...
func (item *TlsArray) WriteJSON(w []byte) (_ []byte, err error) {
	...
	if w, err = item.Multiplicity.WriteJSON(w); err != nil {
		return w, err
	}
	if item.ArgsNum != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"args_num":`...)
		w = JSONWriteUint32(w, item.ArgsNum)
	}
	if len(item.Args) != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"args":`...)
		if w, err = TupleTlsArgBoxedWriteJSON(w, item.Args, item.ArgsNum); err != nil {
			return w, err
		}
	}
	return append(w, '}'), nil
...
func (item *TlsTypeExpr) Read(w []byte) (_ []byte, err error) {
	...
	if w, err = NatRead(w, &item.ChildrenNum); err != nil {
		return w, err
	}
	return TupleTlsExprBoxedRead(w, &item.Children, item.ChildrenNum)
}

func (item *TlsTypeExpr) Write(w []byte) (_ []byte, err error) {
	w = IntWrite(w, item.Name)
	w = IntWrite(w, item.Flags)
	w = NatWrite(w, item.ChildrenNum)
	return TupleTlsExprBoxedWrite(w, item.Children, item.ChildrenNum)
}

func (item *TlsTypeExpr) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = NatReadExactTag(w, 0xc1863d08); err != nil {
		return w, err
	}
	return item.Read(w)
}
...
func (item *TlsTypeExpr) readJSON(j interface{}) error {
	...
	if err := TupleTlsExprBoxedReadJSON(_jChildren, &item.Children, item.ChildrenNum); err != nil {
		return err
	}
	return nil
}
...
func (item *TlsTypeExpr) WriteJSON(w []byte) (_ []byte, err error) {
	...
	if item.ChildrenNum != 0 {
		...
		w = JSONWriteUint32(w, item.ChildrenNum)
	}
	if len(item.Children) != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"children":`...)
		if w, err = TupleTlsExprBoxedWriteJSON(w, item.Children, item.ChildrenNum); err != nil {
			return w, err
		}
	}
	return append(w, '}'), nil
...
func (item *TlsTypeExprUnion) WriteBoxed(w []byte) (_ []byte, err error) {
	w = NatWrite(w, _TlsTypeExprUnion[item.index].TLTag)
	switch item.index {
	case 0:
...
func (item *TlsTypeExprUnion) WriteJSON(w []byte) (_ []byte, err error) {
	...
	case 0:
		...
		if w, err = item.valueTypeVar.WriteJSON(w); err != nil {
			return w, err
		}
		return append(w, '}'), nil
	case 1:
		w = append(w, `{"type":"tls.array#d9fb20de","value":`...)
		if w, err = item.valueArray.WriteJSON(w); err != nil {
			return w, err
		}
		return append(w, '}'), nil
	case 2:
		w = append(w, `{"type":"tls.typeExpr#c1863d08","value":`...)
		if w, err = item.valueTypeExpr.WriteJSON(w); err != nil {
			return w, err
		}
		return append(w, '}'), nil
	default: // Impossible due to panic above
...
func (item *TlsTypeVar) Read(w []byte) (_ []byte, err error) {
	if w, err = IntRead(w, &item.VarNum); err != nil {
		return w, err
	}
	return IntRead(w, &item.Flags)
}

func (item *TlsTypeVar) Write(w []byte) (_ []byte, err error) {
	w = IntWrite(w, item.VarNum)
	return IntWrite(w, item.Flags), nil
}

func (item *TlsTypeVar) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = NatReadExactTag(w, 0x142ceae); err != nil {
		return w, err
	}
	return item.Read(w)
}
