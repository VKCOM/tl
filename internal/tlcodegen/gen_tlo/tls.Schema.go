...
func (item *TlsSchemaUnion) WriteBoxed(w []byte) (_ []byte, err error) {
	w = NatWrite(w, _TlsSchemaUnion[item.index].TLTag)
	switch item.index {
	case 0:
...
func (item *TlsSchemaUnion) WriteJSON(w []byte) (_ []byte, err error) {
	...
	case 0:
		...
		if w, err = item.valueV2.WriteJSON(w); err != nil {
			return w, err
		}
		return append(w, '}'), nil
	case 1:
		w = append(w, `{"type":"tls.schema_v3#e4a8604b","value":`...)
		if w, err = item.valueV3.WriteJSON(w); err != nil {
			return w, err
		}
		return append(w, '}'), nil
	case 2:
		w = append(w, `{"type":"tls.schema_v4#90ac88d7","value":`...)
		if w, err = item.valueV4.WriteJSON(w); err != nil {
			return w, err
		}
		return append(w, '}'), nil
	default: // Impossible due to panic above
...
func (item *TlsSchemaV2) Read(w []byte) (_ []byte, err error) {
	if w, err = IntRead(w, &item.Version); err != nil {
		return w, err
	}
	if w, err = IntRead(w, &item.Date); err != nil {
		return w, err
	}
	if w, err = NatRead(w, &item.TypesNum); err != nil {
		return w, err
	}
	if w, err = TupleTlsTypeBoxedRead(w, &item.Types, item.TypesNum); err != nil {
		return w, err
	}
	if w, err = NatRead(w, &item.ConstructorNum); err != nil {
		return w, err
	}
	if w, err = TupleTlsCombinatorBoxedRead(w, &item.Constructors, item.ConstructorNum); err != nil {
		return w, err
	}
	if w, err = NatRead(w, &item.FunctionsNum); err != nil {
		return w, err
	}
	return TupleTlsCombinatorBoxedRead(w, &item.Functions, item.FunctionsNum)
}

func (item *TlsSchemaV2) Write(w []byte) (_ []byte, err error) {
	w = IntWrite(w, item.Version)
	w = IntWrite(w, item.Date)
	w = NatWrite(w, item.TypesNum)
	if w, err = TupleTlsTypeBoxedWrite(w, item.Types, item.TypesNum); err != nil {
		return w, err
	}
	w = NatWrite(w, item.ConstructorNum)
	if w, err = TupleTlsCombinatorBoxedWrite(w, item.Constructors, item.ConstructorNum); err != nil {
		return w, err
	}
	w = NatWrite(w, item.FunctionsNum)
	return TupleTlsCombinatorBoxedWrite(w, item.Functions, item.FunctionsNum)
}

func (item *TlsSchemaV2) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = NatReadExactTag(w, 0x3a2f9be2); err != nil {
		return w, err
	}
	return item.Read(w)
}
...
func (item *TlsSchemaV2) readJSON(j interface{}) error {
	...
	if err := TupleTlsTypeBoxedReadJSON(_jTypes, &item.Types, item.TypesNum); err != nil {
		return err
	}
	if err := TupleTlsCombinatorBoxedReadJSON(_jConstructors, &item.Constructors, item.ConstructorNum); err != nil {
		return err
	}
	if err := TupleTlsCombinatorBoxedReadJSON(_jFunctions, &item.Functions, item.FunctionsNum); err != nil {
		return err
	}
	return nil
}
...
func (item *TlsSchemaV2) WriteJSON(w []byte) (_ []byte, err error) {
	...
	if item.Version != 0 {
		...
		w = append(w, `"version":`...)
		w = JSONWriteInt32(w, item.Version)
	}
	if item.Date != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"date":`...)
		w = JSONWriteInt32(w, item.Date)
	}
	if item.TypesNum != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"types_num":`...)
		w = JSONWriteUint32(w, item.TypesNum)
	}
	if len(item.Types) != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"types":`...)
		if w, err = TupleTlsTypeBoxedWriteJSON(w, item.Types, item.TypesNum); err != nil {
			return w, err
		}
	}
	if item.ConstructorNum != 0 {
		...
		w = JSONWriteUint32(w, item.ConstructorNum)
	}
	if len(item.Constructors) != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"constructors":`...)
		if w, err = TupleTlsCombinatorBoxedWriteJSON(w, item.Constructors, item.ConstructorNum); err != nil {
			return w, err
		}
	}
	if item.FunctionsNum != 0 {
		...
		w = JSONWriteUint32(w, item.FunctionsNum)
	}
	if len(item.Functions) != 0 {
		w = JSONAddCommaIfNeeded(w)
		w = append(w, `"functions":`...)
		if w, err = TupleTlsCombinatorBoxedWriteJSON(w, item.Functions, item.FunctionsNum); err != nil {
			return w, err
		}
	}
	return append(w, '}'), nil
...
func (item *TlsSchemaV3) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = NatReadExactTag(w, 0xe4a8604b); err != nil {
		return w, err
	}
	return item.Read(w)
}
...
func (item *TlsSchemaV4) ReadBoxed(w []byte) (_ []byte, err error) {
	if w, err = NatReadExactTag(w, 0x90ac88d7); err != nil {
		return w, err
	}
	return item.Read(w)
}
