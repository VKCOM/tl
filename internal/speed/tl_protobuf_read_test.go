...
func BenchmarkMemcacheValueReadTLGen(b *testing.B) {
...
func BenchmarkMemcacheValueReadTL2Gen(b *testing.B) {
	values, buf := prepareTLMemValuesBuffer()
	ctx := basictl.TL2WriteContext{SizeBuffer: make([]int, 1000)}
...
func BenchmarkMemcacheValueReadProtoFastGen(b *testing.B) {
