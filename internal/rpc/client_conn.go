...
import (
	...
	"github.com/vkcom/tl/internal/rpc/internal/gen/tl"
	"github.com/vkcom/tl/internal/srvfunc"
)
...
func (pc *clientConn) handlePacket(pkt *Response, pongCC chan<- int64) (put bool, _ error) {
	...
	default:
		pc.client.opts.Logf("unknown packet type 0x%x", pkt.responseType)
		return true, nil
	}
}
